    ...
    for (let i = 0; i < files.length; i++) {
        ...
        reader.onload = function (event) {
            ...
            imgPreview.innerHTML = `
                ...
                <button type="button" class="remove-image" data-index="${selectedImages.length - 1}">×</button>
            `;
            ...
            messageContent += `
                <div class="image-wrapper mt-2">
                    ...
                    <div class="image-actions">
                        <button type="button" class="btn btn-sm bg-body-secondary rounded btn-icon image-action-download position-absolute top-0 end-0 mt-1 me-1" data-src="${img}">
