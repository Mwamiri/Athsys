<aside class="pe-app-sidebar" id="sidebar">
    <div class="pe-app-sidebar-logo px-5 justify-content-center d-flex align-items-center position-relative">
        <!--begin::Brand Image-->
        <a href="/" class="d-flex gap-2 align-items-center logo-main">
        ...
        <button type="button" id="sidebarDefaultArrow" class="btn btn-sm p-0 fs-4 ms-auto float-end d-none icon-hover-btn text-white d-none"><i class="ri-arrow-right-double-line"></i></button>
        <!--end::Brand Image-->
    </div>
    <nav class="pe-app-sidebar-menu nav nav-pills" data-simplebar id="sidebar-simplebar">
        <div class="d-flex align-items-start flex-column w-100">
            <ul class="pe-main-menu list-unstyled">
                ...
                <li class="pe-slide pe-has-sub">
                    ...
                    <ul class="pe-slide-menu collapse" id="collapseDashboards">
                        ...
                        <li class="pe-slide-item">
                            <a href="/dashboard-fitness" class="pe-nav-link">
                                Fitness
                            </a>
                        </li>
                        <li class="pe-slide-item">
                            <a href="/dashboard-prodcast" class="pe-nav-link">
                                Prodcast
                            </a>
                        </li>
                        <li class="pe-slide-item">
                            <a href="/dashboard-real-estate" class="pe-nav-link">
                                Real Estate
                            </a>
                        </li>
                    </ul>
                ...
                <li class="pe-slide pe-has-sub">
                    ...
                    <ul class="pe-slide-menu collapse" id="collapseApplications">
                        ...
                        <li class="pe-slide-item pe-has-sub">
                            <a href="#collapseHR" class="pe-nav-link" data-bs-toggle="collapse" aria-expanded="false" aria-controls="collapseHR">
                                <span class="pe-nav-sub-content">HR</span>
                                <i class="ri-arrow-down-s-line pe-nav-arrow"></i>
                            </a>
                            <ul class="pe-slide-menu collapse" id="collapseHR">
                                <li class="pe-slide-item">
                                    <a href="/apps-hr-employee-list" class="pe-nav-link">
                                        Employee List
                                    </a>
                                </li>
                                <li class="pe-slide-item pe-has-sub">
                                    <a href="#collapsePayroll" class="pe-nav-link" data-bs-toggle="collapse" aria-expanded="false" aria-controls="collapsePayroll">
                                        <span class="pe-nav-sub-content">Payroll</span>
                                        <i class="ri-arrow-down-s-line pe-nav-arrow"></i>
                                    </a>
                                    <ul class="pe-slide-menu collapse" id="collapsePayroll">
                                        <li class="pe-slide-item">
                                            <a href="/apps-hr-payroll-employee-salary" class="pe-nav-link">
                                                Employee Salary
                                            </a>
                                        </li>
                                        <li class="pe-slide-item">
                                            <a href="/apps-hr-payroll-payslip" class="pe-nav-link">
                                                Payslip
                                            </a>
                                        </li>
                                    </ul>
                                ...
                                <li class="pe-slide-item pe-has-sub">
                                    <a href="#collapseAttendance" class="pe-nav-link" data-bs-toggle="collapse" aria-expanded="false" aria-controls="collapseAttendance">
                                        <span class="pe-nav-sub-content">Attendance</span>
                                        <i class="ri-arrow-down-s-line pe-nav-arrow"></i>
                                    </a>
                                    <ul class="pe-slide-menu collapse" id="collapseAttendance">
                                        <li class="pe-slide-item">
                                            <a href="/apps-hr-attendance" class="pe-nav-link">
                                                Attendance (HR)
                                            </a>
                                        </li>
                                        <li class="pe-slide-item">
                                            <a href="/apps-hr-main-attendance" class="pe-nav-link">
                                                Main Attendance
                                            </a>
                                        </li>
                                    </ul>
                                ...
                                <li class="pe-slide-item pe-has-sub">
                                    <a href="#collapseLeave" class="pe-nav-link" data-bs-toggle="collapse" aria-expanded="false" aria-controls="collapseLeave">
                                        <span class="pe-nav-sub-content">Leave Manage</span>
                                        <i class="ri-arrow-down-s-line pe-nav-arrow"></i>
                                    </a>
                                    <ul class="pe-slide-menu collapse" id="collapseLeave">
                                        <li class="pe-slide-item">
                                            <a href="/apps-hr-leave" class="pe-nav-link">
                                                Leave (HR)
                                            </a>
                                        </li>
                                        <li class="pe-slide-item">
                                            <a href="/apps-hr-employee-leave" class="pe-nav-link">
                                                Leave (Employee)
                                            </a>
                                        </li>
                                        <li class="pe-slide-item">
                                            <a href="/apps-hr-add-leave" class="pe-nav-link">
                                                Add Leave
                                            </a>
                                        </li>
                                    </ul>
                                ...
                                <li class="pe-slide-item">
                                    <a href="/apps-hr-performance" class="pe-nav-link">
                                        Performance
                                    </a>
                                </li>
                                <li class="pe-slide-item">
                                    <a href="/apps-hr-holidays" class="pe-nav-link">
                                        Holidays
                                    </a>
                                </li>
                            </ul>
                        ...
                        <li class="pe-slide-item pe-has-sub">
                            <a href="#collapseProdcast" class="pe-nav-link" data-bs-toggle="collapse" aria-expanded="false" aria-controls="collapseProdcast">
                                <span class="pe-nav-sub-content">Prodcast</span>
                                <i class="ri-arrow-down-s-line pe-nav-arrow"></i>
                            </a>
                            <ul class="pe-slide-menu collapse" id="collapseProdcast">
                                <li class="pe-slide-item">
                                    <a href="/apps-prodcast-list" class="pe-nav-link">
                                        Prodcast List
                                    </a>
                                </li>
                                <li class="pe-slide-item">
                                    <a href="/apps-prodcast-episode-manage" class="pe-nav-link">
                                        Episode Manage
                                    </a>
                                </li>
                                <li class="pe-slide-item">
                                    <a href="/apps-prodcast-audience-analytics" class="pe-nav-link">
                                        Audience Analytics
                                    </a>
                                </li>
                            </ul>
                        ...
                        <li class="pe-slide-item pe-has-sub">
                            <a href="#collapseRealEstate" class="pe-nav-link" data-bs-toggle="collapse" aria-expanded="false" aria-controls="collapseRealEstate">
                                <span class="pe-nav-sub-content">Real Estate</span>
                                <i class="ri-arrow-down-s-line pe-nav-arrow"></i>
                            </a>
                            <ul class="pe-slide-menu collapse" id="collapseRealEstate">
                                <li class="pe-slide-item pe-has-sub">
                                    <a href="#collapseProperty" class="pe-nav-link" data-bs-toggle="collapse" aria-expanded="false" aria-controls="collapseProperty">
                                        <span class="pe-nav-sub-content">Property</span>
                                        <i class="ri-arrow-down-s-line pe-nav-arrow"></i>
                                    </a>
                                    <ul class="pe-slide-menu collapse" id="collapseProperty">
                                        <li class="pe-slide-item">
                                            <a href="/apps-real-estate-property-list" class="pe-nav-link">
                                                Property List
                                            </a>
                                        </li>
                                        <li class="pe-slide-item">
                                            <a href="/apps-real-estate-property-details" class="pe-nav-link">
                                                Property Details
                                            </a>
                                        </li>
                                        <li class="pe-slide-item">
                                            <a href="/apps-real-estate-add-property" class="pe-nav-link">
                                                Add Property
                                            </a>
                                        </li>
                                    </ul>
                                ...
                                <li class="pe-slide-item">
                                    <a href="/apps-real-estate-agents" class="pe-nav-link">
                                        Agents
                                    </a>
                                </li>
                                <li class="pe-slide-item">
                                    <a href="/apps-real-estate-clinets" class="pe-nav-link">
                                        Clients
                                    </a>
                                </li>
                            </ul>
                ...
                <li class="pe-slide pe-has-sub">
                    ...
                    <ul class="pe-slide-menu collapse" id="collapseIcons">
                        ...
                        <li class="pe-slide-item">
                            <a href="/icons-lucide" class="pe-nav-link">
                                Lucide Icons
                            </a>
                        </li>
                    </ul>
            ...
            <!-- Widgets -->
            <div class="sidebar-widget p-4 text-center rounded">
                <img height="30" width="30" class="mx-auto d-block mb-4" alt="Dark Logo" src="assets/images/logo-md.png">
                <h6 class="mb-1 fw-medium">View + Event Limit</h6>
                <p class="mb-4 fs-13 opacity-40">Visit to our help center.</p>
                <a href="#!" class="btn btn-light-secondary py-2 px-4 rounded d-block w-100 mb-2">Learn more</a>
                <a href="#!" class="btn btn-light w-100 position-relative">
                    Upgrade plan
                    <div class="w-25px h-25px bg-primary rounded position-absolute top-50 end-0 translate-middle-y me-1 fs-5 d-flex align-items-center justify-content-center">
