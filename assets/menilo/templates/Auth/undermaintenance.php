<?= $this->element('title_meta', ['title' => 'Under Maintenance']) ?>

<!-- START -->
<div>
    <img src="assets/images/vector/launch.png" alt="Startup Plan"
        class="launch-img object-fit-cover animate-bounce d-none d-xl-block">
    ...
    <div class="px-3 px-md-8 py-5 position-absolute top-0 d-flex justify-content-between align-items-center w-100 z-1">
        <a href="index.html" class="d-flex align-items-end logo-main">
            ...
            <h3 class="text-body-emphasis fw-bolder mb-0 ms-1">Menilo</h3>
        </a>
        ...
        <div class="row position-relative justify-content-center align-items-center min-vh-100">
            <div class="col-xl-8">
                <div class="text-center py-20 py-md-16">
                    <img src="assets/images/vector/maintenance.png" alt="Under Maintenance"
                        class="img-fluid w-320px mb-12">
                    <h1 class="mb-4 fs-55 text-primary">We’re Under Maintenance</h1>
                    <p class="max-w-600px mx-auto fs-15 text-muted">Our site is currently undergoing scheduled
                        maintenance to bring you an even better experience. We’ll be back shortly. Thanks for your
                        patience!</p>
