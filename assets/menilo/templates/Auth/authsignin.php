    ...
    <div class="col-12 col-md-8 col-lg-6 col-xl-5">
      <div class="card mx-xxl-8 shadow-none">
        <div class="card-body p-8">
            ...
            <div class="mb-4">
              ...
              <div class="position-relative">
                ...
                <button type="button"
                  ...
                  id="toggle-password" data-target="password"><i class="ri-eye-off-line align-middle"></i></button>
              </div>
            </div>
            <div class="my-6">
              <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="form-text">
                  <a href="auth-forgot-password.html" class="link link-primary">Forgot password?</a>
                </div>
              </div>
            </div>
            <div>
          ...
          <p class="text-center mt-6 mb-0 text-muted fs-13">Don't have an account? <a href="auth-signup.html"
              class="link link-primary fw-semibold">Sign up here</a></p>
        </div>
      </div>
