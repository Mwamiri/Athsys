<?= $this->element('title_meta', ['title' => 'Sign Out']) ?>
      ...
      <div class="card mx-xxl-8 shadow-none">
        <div class="card-body p-8 text-center">
          ...
          <div class="d-grid gap-4">
            <a href="auth-signin.html" class="btn btn-primary w-100">Sign In Again</a>
            <a href="index.html" class="btn btn-outline-light w-100 text-muted"><i class="ri-home-4-line me-2"></i>Back
              to Homepage</a>
          </div>
        </div>
      </div>
