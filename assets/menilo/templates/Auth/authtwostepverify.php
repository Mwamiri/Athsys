<?= $this->element('title_meta', ['title' => 'Two Step Verification']) ?>
        ...
        <div class="col-12 col-md-8 col-lg-6 col-xl-5">
            <div class="card mx-xxl-8 shadow-none">
                <div class="card-body p-8">
                    <img src="assets/images/auth/email.png" alt="Email Image"
                        class="h-56px w-56px mx-auto d-block mb-3">
                    <h3 class="fw-medium text-center">Two-Factor Authentication</h3>
                    <p class="text-muted text-center mb-8">6 digit OTP is send to mobile number <strong
                            class="text-body">info@gmail.com</strong></p>
                    <form>
                        <div id="otp-container" class="d-flex align-items-center justify-content-center gap-2 mb-6">
                            <input type="text" class="form-control text-center min-h-50px max-w-64px border rounded"
                        ...
                        <a href="auth-reset-password.html" class="btn btn-primary w-100">Reset Password</a>
                    </form>
                    <p class="text-center mt-6 mb-0 text-muted fs-13">Didn't receive the code? <a
                            href="javascript:void(0)" class="link link-primary fw-semibold">Resend</a></p>
                </div>
            </div>
            <p class="position-relative text-center fs-13 mb-0">©
                <script>document.write(new Date().getFullYear())</script> Menilo. Crafted with by Pixeleyez
            </p>
        </div>
    </div>
</div>
