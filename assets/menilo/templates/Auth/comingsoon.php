<?= $this->element('title_meta', ['title' => 'Coming Soon']) ?>
    ...
    <div class="row position-relative justify-content-center align-items-center min-vh-100">
      <div class="col-lg-8">
        <div class="text-center py-20 py-md-16">
          ...
          <p class="max-w-600px mx-auto fs-15 text-muted">Something exciting is on the way. Stay tuned — we’re almost
            ready to launch. Subscribe below to be the first to know when we go live.</p>
          <form class="mt-12">
            <div id="countdown">
            ...
            <div class="position-relative subscribe-btn max-w-500px mt-10 mx-auto">
              <input type="text" class="form-control min-h-56px form-control-icon" id="companyNameLayout4"
