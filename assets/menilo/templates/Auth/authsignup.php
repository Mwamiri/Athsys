<?= $this->element('title_meta', ['title' => 'Sign Up']) ?>
            ...
            <div class="card mx-xxl-8 shadow-none">
                <div class="card-body p-8">
                    ...
                    <form>
                        ...
                        <div>
                            <a href="index.html" class="btn btn-primary w-100 mb-4">Sign Up</a>
                            <button type="button"
                                class="btn btn-outline-light w-100 d-flex align-items-center gap-2 justify-content-center text-muted">
                                <img src="assets/images/google.png" alt="Google Logo" class="h-20px w-20px">Sign in with
                                Google
                            </button>
                        </div>
                    </form>
                    <p class="text-center mt-6 mb-0 text-muted fs-13">Already have an account? <a
                            href="auth-signin.html" class="link link-primary fw-semibold">Sign In here</a></p>
                </div>
            </div>
