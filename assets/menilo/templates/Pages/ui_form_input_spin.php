...
<?= $this->element('page_title', ['title' => 'Forms', 'subTitle' => 'Input Spin']) ?>
...
<div class="row">
    <div class="col-12">
        <div class="card card-h-100">
            ...
            <div class="card-body">
                <p class="text-muted mb-4">Touchspin allows users to increase or decrease a numerical input using plus
                    and minus buttons. Use <code>qty-input</code> classes to apply different styles.</p>
                <div class="row g-5">
    ...
    <div class="col-12">
        <div class="card card-h-100">
            <div class="card-header">
                <h5 class="card-title">Outlined Touchspin</h5>
            </div>
            <div class="card-body">
                <p class="text-muted mb-4">Use <code>qty-input-outline</code> along with contextual classes to display
                    outlined touchspin controls for number inputs with increment and decrement functionality.</p>
                <div class="row g-5">
                    <div class="col-12 col-md-4 col-xl-3">
    ...
    <div class="col-12">
        <div class="card card-h-100">
            <div class="card-header">
                <h5 class="card-title">Rounded Touchspin</h5>
            </div>
            <div class="card-body">
                <p class="text-muted mb-4">Use <code>.qty-input-rounded</code> to apply rounded styles to your number
                    input spin controls, along with contextual background classes for visual variation.</p>
                <div class="row g-5">
                    <div class="col-12 col-md-4 col-xl-3">
