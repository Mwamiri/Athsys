<?= $this->element('title_meta', ['title' => 'UI Columns']) ?>
...
<div class="container-fluid ">
    ...
    <?= $this->element('page_title', ['title' => 'Base UI', 'subTitle' => 'Columns']) ?>
    ...
    <div class="row">
        ...
        <div class="col-12 col-xl-6">
            <div class="card card-h-100">
                <div class="card-header">
                    <h5 class="card-title">Basic Date Picker</h5>
                </div>
                <div class="card-body">
                    <p class="text-muted">Create a basic date picker by initializing Air Datepickr with
                        <code>Air Datepickr("#basic-picker")</code> to allow users to select a single date from a
                        calendar.</p>
        ...
        <div class="col-12 col-xl-6">
            <div class="card card-h-100">
                <div class="card-header">
                    <h5 class="card-title">Select date on initialization</h5>
                </div>
                <div class="card-body">
        ...
        <div class="col-12 col-xl-6">
            <div class="card card-h-100">
                <div class="card-header">
                    <h5 class="card-title">Month selection</h5>
                </div>
                <div class="card-body">
        ...
        <div class="col-12 col-xl-6">
            <div class="card card-h-100">
                <div class="card-header">
                    <h5 class="card-title">Mobile devices mode</h5>
                </div>
                <div class="card-body">
        ...
        <div class="col-12 col-xl-6">
            <div class="card card-h-100">
                <div class="card-header">
                    <h5 class="card-title">Range of dates</h5>
                </div>
                <div class="card-body">
        ...
        <div class="col-12 col-xl-6">
            <div class="card card-h-100">
                <div class="card-header">
                    <h5 class="card-title">Cells content</h5>
                </div>
                <div class="card-body">
                    <p class="text-muted">Air Datepicker allows you to change cells content anyway you want. Content,
                        classes and status (active/disabled) are controlled by option
                        <code>{onRenderCell:({date, cellType})=>{})}.</code> </p>
        ...
        <div class="col-12 col-xl-6">
            <div class="card card-h-100">
                <div class="card-header">
                    <h5 class="card-title">Preinstalled buttons</h5>
                </div>
                <div class="card-body">
