<?= $this->element('title_meta', ['title' => 'UI Breadcrumbs']) ?>

<!-- prism css -->
<link rel="stylesheet" href="assets/libs/prismjs/themes/prism-coy.min.css">

<?= $this->element('page_title', ['title' => 'Base UI', 'subTitle' => 'Breadcrumbs']) ?>
...
<div class="row">
    <div class="col-xl-6">
        <div class="card card-h-100">
            ...
            <div class="card-body">
                <p class="text-muted">Create navigational links with Bootstrap's <code>.breadcrumb</code> component. Use
                    <code>&lt;nav&gt;</code> and <code>&lt;ol class="breadcrumb"&gt;</code> to display a breadcrumb
                    trail, indicating the current page's location.</p>
...
&lt;/nav&gt;</code></pre>
    ...
    <div class="col-xl-6">
        <div class="card card-h-100">
            <div class="card-header">
                <h5 class="card-title">Breadcrumb with line icon</h5>
                <ul class="nav nav-pills nav-preview nav-primary mb-0" id="line-icon-with-breadcrumbs" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="html-line-icon-with-breadcrumbs-tab" data-bs-toggle="pill"
                            data-bs-target="#html-line-icon-with-breadcrumbs" type="button" role="tab"
                            aria-controls="html-line-icon-with-breadcrumbs" aria-selected="true">HTML</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="preview-line-icon-with-breadcrumbs-tab" data-bs-toggle="pill"
                            ...
                            aria-controls="preview-line-icon-with-breadcrumbs" aria-selected="false">Preview</button>
                    </li>
                </ul>
            </div>
            <div class="card-body">
...
&lt;/nav&gt;</code></pre>
    ...
    <div class="col-xl-6">
        <div class="card card-h-100">
            <div class="card-header">
                <h5 class="card-title">Breadcrumb with arrow icon</h5>
                <ul class="nav nav-pills nav-preview nav-primary mb-0" id="arrow-icon-with-breadcrumbs" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="html-arrow-icon-with-breadcrumbs-tab" data-bs-toggle="pill"
                            data-bs-target="#html-arrow-icon-with-breadcrumbs" type="button" role="tab"
                            aria-controls="html-arrow-icon-with-breadcrumbs" aria-selected="true">HTML</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="preview-arrow-icon-with-breadcrumbs-tab" data-bs-toggle="pill"
                            data-bs-target="#preview-arrow-icon-with-breadcrumbs" type="button" role="tab"
                            aria-controls="preview-arrow-icon-with-breadcrumbs" aria-selected="false">Preview</button>
                    </li>
                </ul>
            </div>
            <div class="card-body">
                <p class="text-muted"> Use the custom <code>.breadcrumb-arrow</code> class to create breadcrumb trails
                    with arrow-shaped separators using Remix Icons. Apply it to the
                    <code>&lt;ol class="breadcrumb"&gt;</code> for a stylish, icon-based navigation.</p>
...
&lt;/nav&gt;</code></pre>
    ...
    <div class="col-xl-6">
        <div class="card card-h-100">
            <div class="card-header">
                <h5 class="card-title">Breadcrumb with double arrow icon</h5>
                <ul class="nav nav-pills nav-preview nav-primary mb-0" id="double-arrow-icon-with-breadcrumbs"
                    role="tablist">
                    <li class="nav-item" role="presentation">
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="preview-double-arrow-icon-with-breadcrumbs-tab"
                            ...
                            type="button" role="tab" aria-controls="preview-double-arrow-icon-with-breadcrumbs"
                            aria-selected="false">Preview</button>
                    </li>
                </ul>
            </div>
            <div class="card-body">
                <p class="text-muted">Use the custom <code>.breadcrumb-double-arrow</code> class to create breadcrumb
                    trails with double arrow separators using Remix Icons. Apply it to the
                    <code>&lt;ol class="breadcrumb"&gt;</code> for a unique and visually distinct navigation style.</p>
                <div class="tab-content" id="double-arrow-icon-with-breadcrumbsContent">
                    <div class="tab-pane fade show active" id="html-double-arrow-icon-with-breadcrumbs" role="tabpanel"
                        aria-labelledby="html-double-arrow-icon-with-breadcrumbs-tab" tabindex="0">
                        <nav aria-label="breadcrumb">
        ...
        <div class="card card-h-100">
            <div class="card-header">
                ...
                <ul class="nav nav-pills nav-preview nav-primary mb-0" id="breadcrumb-double-arrow" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="html-breadcrumb-double-arrow-tab" data-bs-toggle="pill"
                            data-bs-target="#html-breadcrumb-double-arrow" type="button" role="tab"
                            aria-controls="html-breadcrumb-double-arrow" aria-selected="true">HTML</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="preview-breadcrumb-double-arrow-tab" data-bs-toggle="pill"
                            data-bs-target="#preview-breadcrumb-double-arrow" type="button" role="tab"
                            aria-controls="preview-breadcrumb-double-arrow" aria-selected="false">Preview</button>
                    </li>
                </ul>
            </div>
            <div class="card-body">
                ...
                <div class="tab-content" id="breadcrumb-double-arrowContent">
                    <div class="tab-pane fade show active" id="html-breadcrumb-double-arrow" role="tabpanel"
                        aria-labelledby="html-breadcrumb-double-arrow-tab" tabindex="0">
                        <nav aria-label="breadcrumb">
                    ...
                    <div class="tab-pane fade" id="preview-breadcrumb-double-arrow" role="tabpanel"
                        aria-labelledby="preview-breadcrumb-double-arrow-tab" tabindex="0">
