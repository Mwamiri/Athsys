<?= $this->element('title_meta', ['title' => 'UI Images Figures']) ?>

<!-- prism css -->
<link rel="stylesheet" href="assets/libs/prismjs/themes/prism-coy.min.css">

<?= $this->element('page_title', ['title' => 'Base UI', 'subTitle' => 'Images Figures']) ?>

<div class="row">
    <div class="col-12 col-md-6 col-xl-4">
        <div class="card card-h-100">
            <div class="card-header">
                <h5 class="card-title">1:1 Aspect Ratio</h5>
            ...
            <div class="card-body">
                <p class="text-muted">Ensure <strong>1:1 aspect ratio</strong> for images by applying
                    <code>.image-wrapper</code> and <code>.image-1x1</code> classes. This maintains a square shape for
...
&lt;/div&gt;</code></pre>
    ...
    <div class="col-12 col-md-6 col-xl-4">
        <div class="card card-h-100">
            <div class="card-header">
                <h5 class="card-title">4:3 Aspect Ratio</h5>
            ...
            <div class="card-body">
                <p class="text-muted">Use <strong>4:3 aspect ratio</strong> for images with the
                    <code>.image-wrapper .image-4x3</code> class. Apply this class to maintain a 4:3 ratio for your
                    images and elements.
                </p>
...
&lt;/div&gt;</code></pre>
    ...
    <div class="col-12 col-md-6 col-xl-4">
        <div class="card card-h-100">
            <div class="card-header">
                <h5 class="card-title">3:2 Aspect Ratio</h5>
            ...
            <div class="card-body">
                <p class="text-muted">Use the <strong>3:2 aspect ratio</strong> by applying the
                    <code>.image-wrapper .image-3x2</code> class to your elements. This ensures your images and content
                    maintain a 3:2 ratio.
                </p>
...
&lt;/div&gt;</code></pre>
    ...
    <div class="col-12 col-md-6 col-xl-4">
        <div class="card card-h-100">
            <div class="card-header">
                <h5 class="card-title">16:9 Aspect Ratio</h5>
            ...
            <div class="card-body">
                <p class="text-muted"> Maintain a <strong>16:9 aspect ratio</strong> by using the
                    <code>.image-wrapper .image-16x9</code> class. Apply this class to ensure your images and elements
                    keep a 16:9 ratio.
                </p>
        ...
        <div class="card card-h-100">
                ...
                <ul class="nav nav-pills nav-preview nav-primary mb-0" id="figures" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="html-figures-tab" data-bs-toggle="pill"
                            data-bs-target="#html-figures" type="button" role="tab" aria-controls="html-figures"
                            aria-selected="true">HTML</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="preview-figures-tab" data-bs-toggle="pill"
                            data-bs-target="#preview-figures" type="button" role="tab" aria-controls="preview-figures"
            ...
            <div class="card-body">
                <p class="text-muted">Use Bootstrap's <code>&lt;figure&gt;</code> component to display images with
                    ...
                    <code>&lt;figcaption&gt;</code> for the caption below the image.
                </p>
...
&lt;/figure&gt;</code></pre>
    ...
    <div class="col-12 col-md-6 col-xl-4">
        <div class="card card-h-100">
            <div class="card-header">
                <h5 class="card-title">Image With Radius</h5>
            ...
            <div class="card-body">
                <p class="text-muted">Add a border radius to an <strong>image</strong> with the <code>.rounded-*</code>
                    class. Use this class on the <code>&lt;img&gt;</code> tag for a rounded effect.</p>
...
&lt;/div&gt;</code></pre>
    ...
    <div class="col-12 col-md-6 col-xl-4">
        <div class="card card-h-100">
            ...
            <div class="card-body">
                <p class="text-muted">Left-align an <strong>image</strong> with the <code>.float-start</code> class on
                    the <code>&lt;img&gt;</code> tag.</p>
                <div class="tab-content" id="image-left-alignContent">
                    ...
                    <div class="tab-pane fade" id="preview-image-left-align" role="tabpanel"
                        ...
                        <pre
                            class="language-html"><code>&lt;img class=&quot;rounded float-start&quot; src=&quot;assets/images/avatar/avatar-4.jpg&quot; alt=&quot;...&quot;&gt;</code></pre>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card card-h-100">
            ...
            <div class="card-body">
                <p class="text-muted">Center an <strong>image</strong> with <code>.mx-auto</code> and
                    <code>.d-block</code> on the <code>&lt;img&gt;</code> tag.
                </p>
                <div class="tab-content" id="image-center-alignContent">
                    ...
                    <div class="tab-pane fade" id="preview-image-center-align" role="tabpanel"
                        ...
                        <pre
                            class="language-html"><code>&lt;img class=&quot;rounded mx-auto d-block&quot; src=&quot;assets/images/avatar/avatar-2.jpg&quot; alt=&quot;...&quot;&gt;</code></pre>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-12 col-md-6 col-xl-4">
        <div class="card card-h-100">
            ...
            <div class="card-body">
                <p class="text-muted">Right-align an <strong>image</strong> with the <code>.float-end</code> class on
                    the <code>&lt;img&gt;</code> tag.</p>
                <div class="tab-content" id="image-right-alignContent">
                    ...
                    <div class="tab-pane fade" id="preview-image-right-align" role="tabpanel"
                        ...
                        <pre
                            class="language-html"><code>&lt;img class=&quot;rounded float-end&quot; src=&quot;assets/images/avatar/avatar-3.jpg&quot; alt=&quot;...&quot;&gt;</code></pre>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-12 col-md-6 col-xl-4">
        <div class="card card-h-100">
            <div class="card-header">
                <h5 class="card-title">Rounded Image</h5>
            ...
            <div class="card-body">
                <p class="text-muted">Create a <strong>rounded image</strong> with the <code>.rounded-pill</code> class.
                    Apply this class to the <code>&lt;img&gt;</code> tag for a pill-shaped rounded effect.</p>
                <div class="tab-content" id="image-with-roundedContent">
                    ...
                    <div class="tab-panefade" id="preview-image-with-rounded" role="tabpanel" aria-labelledby="preview-image-with-rounded-tab" tabindex="0">
                                    <pre class="language-html"><code>&lt;div class=&quot;text-center&quot;&gt;
    &lt;img class=&quot;img-fluid rounded-pill&quot; src=&quot;assets/images/avatar/avatar-2.jpg&quot; alt=&quot;...&quot;&gt;
&lt;/div&gt;</code></pre>
                                </div>
                ...
                <div class="col-12 col-md-6 col-xl-4">
                    <div class="card card-h-100">
                        <div class="card-header">
                            <h5 class="card-title">Image Thumbnail</h5>
...
&lt;/div&gt;</code></pre>
                ...
                <div class="col-12 col-md-6 col-xl-4">
                    <div class="card card-h-100">
                        <div class="card-header">
                            <h5 class="card-title">Rounded Thumbnail</h5>
