<?= $this->element('title_meta', ['title' => 'Page']) ?>

<?= $this->element('page_title', ['title' => 'Page', 'subTitle' => 'Blog Details']) ?>
...
<div class="row">
  <div class="col-12 col-xl-8">
      ...
      <div class="card-body">
        <div class="d-flex flex-wrap justify-content-between align-items-center gap-5 mb-6">
          <div class="d-flex align-items-center gap-3">
            <img src="assets/images/avatar/15.jpg" alt="Liam Carter" class="rounded-circle shadow-sm avatar-md">
            <div>
              <a href="pages-profile.html" class="text-body fw-semibold">Alex Morgan <i
                  class="bi bi-patch-check-fill text-primary ms-1 fs-13" title="Verified"></i></a>
              <p class="text-muted mb-0">1 day ago · <span class="text-primary">Designer</span></p>
            </div>
          </div>
        ...
        <a href="#!"><img src="assets/images/small/img-6.jpg" class="img-fluid w-100 h-320px object-fit-cover rounded-3"
            alt="Blog Image"></a>
        <div class="mt-5">
          <div class="d-flex align-items-center justify-content-end gap-5 mb-4">
            <a href="#!" class="text-body"><i class="ri-time-line me-2 text-muted"></i>Mar 2, 2024</a>
            <a href="#!" class="text-body"><i class="ri-eye-line me-2 text-muted"></i>62 views</a>
            <a href="#!" class="text-body"><i class="bi bi-chat-dots me-2 text-muted"></i>15 comments</a>
          </div>
          <h5 class="mb-3">The Enduring Power of Minimalist Design</h5>
          <p class="mb-2 text-muted">
            Minimalism is more than a design trend—it's a philosophy rooted in simplicity, clarity, and purpose. By
            stripping away the non-essential, minimalist design allows key elements to shine, resulting in clean,
            intuitive, and highly functional experiences.
          </p>
          <p class="mb-4 text-muted">
            Emerging in the early 20th century, minimalism was heavily influenced by the Bauhaus movement, which
            emphasized form following function. Over time, this philosophy expanded beyond art and architecture into
            nearly every creative field, including product design, branding, and digital interfaces.
          </p>
          <ul class="list-unstyled list-group list-borderless mb-5 ps-0">
            <li class="list-group-item"><span class="fw-semibold">1920s–1950s:</span> Bauhaus introduces the idea of
              "less but better."</li>
            <li class="list-group-item"><span class="fw-semibold">1960s–1980s:</span> Artists and architects explore
              minimalism as a bold visual statement.</li>
            <li class="list-group-item"><span class="fw-semibold">1990s–Today:</span> Brands like Apple champion
              minimalism in technology and UI/UX design.</li>
          </ul>
          <h5 class="mb-3">Why Minimalism Matters Today</h5>
          <p class="mb-4 text-muted">
            In an age of information overload, minimalism offers relief through clarity and focus. From websites to
            mobile apps, designers favor minimal interfaces for faster load times, better usability, and improved
            accessibility—particularly vital on smaller screens where every pixel counts.
          </p>
          ...
          <ul class="list-unstyled list-group list-borderless mb-8 ps-0">
            <li class="list-group-item"><span class="fw-semibold">Clarity:</span> Removing visual noise for better
              comprehension.</li>
            <li class="list-group-item"><span class="fw-semibold">Efficiency:</span> Optimizing load performance and
              responsiveness.</li>
            <li class="list-group-item"><span class="fw-semibold">Focus:</span> Highlighting only the most essential
              content and actions.</li>
          </ul>
          <div class="px-5 py-6 w-100 rounded-2 bg-light-subtle text-center position-relative">
            ...
            <p class="mb-2 fw-semibold">
              “When you give joy to other people, you get more joy in return. You should give a good thought to the
          ...
          <p class="mb-4 text-muted">
            As our digital lives grow increasingly complex, minimalism remains a powerful guide. Whether designing a
            website, mobile app, or brand identity, embracing simplicity enables designers to create purposeful,
            elegant, and impactful experiences that resonate deeply with users.
          </p>
        </div>
      </div>
    </div>
    <div class="card">
      <div class="card-header">
        <h6 class="card-title fw-semibold">Comments</h6>
      </div>
      <div class="card-body">
        <div class="px-5 mx-n5" data-simplebar style="height: 380px;">
            ...
            <div class="d-flex flex-wrap align-items-start gap-4">
              ...
              <div class="flex-grow-1">
                <div class="d-flex justify-content-between mt-2 mb-3">
                  <h6 class="mb-0 fs-16">Don Russell</h6>
                ...
                <div class="d-flex gap-2">
                  <button type="button" class="btn btn-light-primary btn-sm rounded-2">Reply<i
                      class="bi bi-reply-all-fill fs-14 ms-1"></i></button>
                  <button type="button" class="btn btn-light-danger btn-sm rounded-2">Like<i
          ...
          <div class="p-5 bg-light-subtle rounded-3 mb-4 ms-5 ms-md-16">
            <div class="d-flex flex-wrap align-items-start gap-4">
              <img src="assets/images/avatar/avatar-2.jpg" alt="Emily Carter"
                class="rounded-circle avatar-lg shadow-sm">
              <div class="flex-grow-1">
                <div class="d-flex justify-content-between mt-2 mb-3">
                  <h6 class="mb-0 fs-16">Emily Carter</h6>
                  <small class="text-muted">Feb 02, 2024 • 9:10 AM</small>
                </div>
                <p class="mb-6">
                  Loved how clean and purposeful the layout is! Minimalism isn’t just a trend—it’s a necessity in
                  today’s UI-heavy world.
                </p>
                <div class="d-flex gap-2">
                  <button type="button" class="btn btn-light-primary btn-sm rounded-2">Reply <i
                      class="bi bi-reply-all-fill fs-14 ms-1"></i></button>
          ...
          <div class="p-5 bg-light-subtle rounded-3 mb-4">
            <div class="d-flex flex-wrap align-items-start gap-4">
              <img src="assets/images/avatar/avatar-5.jpg" alt="Jacob Mendez"
                class="rounded-circle avatar-lg shadow-sm">
              <div class="flex-grow-1">
                <div class="d-flex justify-content-between mt-2 mb-3">
                  <h6 class="mb-0 fs-16">Jacob Mendez</h6>
                  <small class="text-muted">Feb 14, 2024 • 3:42 PM</small>
                </div>
                <p class="mb-6">
                  This is exactly the kind of design that makes content feel digestible. Beautiful spacing and
                  readability.
                </p>
                <div class="d-flex gap-2">
                  <button type="button" class="btn btn-light-primary btn-sm rounded-2">Reply <i
          ...
          <div class="p-5 bg-light-subtle rounded-3 mb-4">
            <div class="d-flex flex-wrap align-items-start gap-4">
              ...
              <div class="flex-grow-1">
                <div class="d-flex justify-content-between mt-2 mb-3">
                  <h6 class="mb-0 fs-16">Sophia Lin</h6>
                  <small class="text-muted">Mar 03, 2024 • 8:30 PM</small>
                </div>
                <p class="mb-6">
                  I always appreciate a design that knows when to stop. This keeps things neat without feeling empty.
                  Great job!
                </p>
                <div class="d-flex gap-2">
                  <button type="button" class="btn btn-light-primary btn-sm rounded-2">Reply <i
          ...
          <div class="p-5 bg-light-subtle rounded-3 mb-4 ms-5 ms-md-20">
            <div class="d-flex flex-wrap align-items-start gap-4">
              ...
              <div class="flex-grow-1">
                <div class="d-flex justify-content-between mt-2 mb-3">
                  <h6 class="mb-0 fs-16">Liam Foster</h6>
          ...
          <div class="p-5 bg-light-subtle rounded-3 mb-4">
            <div class="d-flex flex-wrap align-items-start gap-4">
              <img src="assets/images/avatar/avatar-8.jpg" alt="Nora Martinez"
                class="rounded-circle avatar-lg shadow-sm">
              <div class="flex-grow-1">
                <div class="d-flex justify-content-between mt-2 mb-3">
                  <h6 class="mb-0 fs-16">Nora Martinez</h6>
  ...
  <div class="col-12 col-xl-4">
    <div class="blog-details-list mb-6">
        ...
        <div class="card-body">
          <div class="border-bottom pb-4">
            <div class="d-flex gap-4 justify-content-between align-items-center">
              ...
              <div class="flex-grow-1">
                <a href="#!" class="fw-semibold text-body text-decoration-none d-block">Mastering Typography in Web
                  Design</a>
          ...
          <div class="border-bottom py-4">
            <div class="d-flex gap-4 justify-content-between align-items-center">
              ...
              <div class="flex-grow-1">
                <a href="javascript:void(0)" class="fw-semibold text-body text-decoration-none d-block">Visual Hierarchy
                  in UI Design</a>
                <div class="d-flex justify-content-between align-items-center mt-2">
          ...
          <div class="border-bottom py-4">
            <div class="d-flex gap-4 justify-content-between align-items-center">
              ...
              <div class="flex-grow-1">
                <a href="javascript:void(0)" class="fw-semibold text-body text-decoration-none d-block">Capturing
                  Stories Through Portraits</a>
                <div class="d-flex justify-content-between align-items-center mt-2">
          ...
          <div class="py-4">
            <div class="d-flex gap-4 justify-content-between align-items-center">
              ...
              <div class="flex-grow-1">
                <a href="javascript:void(0)" class="fw-semibold text-body text-decoration-none d-block">Creating
                  Immersive Travel Content</a>
      ...
      <div class="card">
        <div class="card-body">
          <div class="text-center">
            <label class="mb-5 px-5 py-3 bg-light-subtle rounded"> Subscribe to get updates about latest <span
                class="fw-bold"> News & Posts</span> </label>
      ...
      <div class="card">
        <div class="card-header">
          <h6 class="card-title fw-semibold">Popular Post</h6>
        </div>
        <div class="card-body">
          <div class="d-flex flex-wrap gap-3">
            <a href="#!"><img src="assets/images/small/img-7.jpg" alt="Blog Post"
                class="img-fluid avatar-xxl object-fit-cover rounded-2"></a>
            <a href="#!"><img src="assets/images/small/img-8.jpg" alt="Blog Post"
                class="img-fluid avatar-xxl object-fit-cover rounded-2"></a>
            <a href="#!"><img src="assets/images/small/img-9.jpg" alt="Blog Post"
                class="img-fluid avatar-xxl object-fit-cover rounded-2"></a>
            <a href="#!"><img src="assets/images/small/img-10.jpg" alt="Blog Post"
                class="img-fluid avatar-xxl object-fit-cover rounded-2"></a>
            <a href="#!"><img src="assets/images/small/img-11.jpg" alt="Blog Post"
                class="img-fluid avatar-xxl object-fit-cover rounded-2"></a>
            <a href="#!"><img src="assets/images/small/img-12.jpg" alt="Blog Post"
                class="img-fluid avatar-xxl object-fit-cover rounded-2"></a>
            <a href="#!"><img src="assets/images/small/img-13.jpg" alt="Blog Post"
                class="img-fluid avatar-xxl object-fit-cover rounded-2"></a>
            <a href="#!"><img src="assets/images/small/img-14.jpg" alt="Blog Post"
                class="img-fluid avatar-xxl object-fit-cover rounded-2"></a>
          </div>
        </div>
      </div>
...
<div class="row">
  <div class="col-12">
    <div class="card">
      <div class="card-header">
        <h6 class="card-title fw-semibold">Leave a Comment</h6>
      </div>
      <div class="card-body">
        <form action="#">
          <div class="row g-4">
            ...
            <div class="col-12 col-xl-6">
              ...
              <input type="text" placeholder="Enter Your Username" class="form-control" id="Username" required>
            </div>
            <div class="col-12 col-xl-6">
            ...
            <div class="col-12">
              <label class="form-label" for="Comment">Write Comment<span class="text-danger ms-1">*</span></label>
              <textarea name="forComment" id="Comment" rows="5" class="form-control"
