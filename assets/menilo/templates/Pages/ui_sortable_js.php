<?= $this->element('title_meta', ['title' => 'Advanced UI Sortable JS']) ?>

<?= $this->element('page_title', ['title' => 'Advanced UI', 'subTitle' => 'Sortable JS']) ?>
            ...
            <div class="row">
                ...
                <div class="col-xl-6">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title"> Simple list example </h5>
                        </div>
                        <div class="card-body">
                            ...
                            <div id="js-sortable" class="list-group">
                                <div class="list-group-item"><span>Item 1</span></div>
                                <div class="list-group-item"><span>Item 2</span></div>
                                <div class="list-group-item"><span>Item 3</span></div>
                                <div class="list-group-item"><span>Item 4</span></div>
                                <div class="list-group-item"><span>Item 5</span></div>
                                <div class="list-group-item"><span>Item 6</span></div>
                            </div>
                        </div>
                    </div>
                </div><!--End col-->
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div id="js-sortable-7" class="list-group">
                                <div class="list-group-item"><span>Item 1</span></div>
                                <div class="list-group-item sortablejs-custom-disabled bg-primary-subtle text-primary"><span>Filtered</span></div>
                                <div class="list-group-item"><span>Item 3</span></div>
                                <div class="list-group-item"><span>Item 4</span></div>
                                <div class="list-group-item"><span>Item 5</span></div>
                                <div class="list-group-item"><span>Item 6</span></div>
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-xl-6">
                                    <div id="js-sortable-3" class="list-group">
                                        <div class="list-group-item bg-light-subtle"><span>Item 1</span></div>
                                        <div class="list-group-item bg-light-subtle"><span>Item 2</span></div>
                                        <div class="list-group-item bg-light-subtle"><span>Item 3</span></div>
                                        <div class="list-group-item bg-light-subtle"><span>Item 4</span></div>
                                        <div class="list-group-item bg-light-subtle"><span>Item 5</span></div>
                                        <div class="list-group-item bg-light-subtle"><span>Item 6</span></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title"> Disable & Clone sorting </h5>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-xl-6">
                                    <div id="js-sortable-5" class="list-group">
                                        <div class="list-group-item bg-light-subtle"><span>Item 1</span></div>
                                        <div class="list-group-item bg-light-subtle"><span>Item 2</span></div>
                                        <div class="list-group-item" draggable="false"><span>Item 3</span></div>
                                        <div class="list-group-item bg-light-subtle"><span>Item 4</span></div>
                                        <div class="list-group-item bg-light-subtle"><span>Item 5</span></div>
                                        <div class="list-group-item" draggable="false"><span>Item 6</span></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div id="js-sortable-9" class="list-group">
                                ...
                                <div class="list-group-item">
                                    ...
                                    <div id="js-sortable-10" class="list-group">
                                        <div class="list-group-item"><span>Item 3.1</span></div>
                                        <div class="list-group-item"><span>Item 3.2</span></div>
                                        <div class="list-group-item"><span>Item 3.3</span></div>
                                        <div class="list-group-item"><span>Item 3.4</span></div>
                                    </div>
                                </div>
                                <div class="list-group-item"><span>Item 4</span></div>
                                <div class="list-group-item"><span>Item 5</span></div>
                            ...
                            <div id="js-sortable-8" class="row">
                                <div class="col-md-2">
                                    <div class="card border">
                                        <div class="card-body text-center"><span>1</span></div>
                                    </div>
                                </div>

                                <div class="col-md-2">
                                    <div class="card border">
                                        <div class="card-body text-center"><span>2</span></div>
                                    </div>
                                </div>

                                <div class="col-md-2">
                                    <div class="card border">
                                        <div class="card-body text-center"><span>3</span></div>
                                    </div>
                                </div>

                                <div class="col-md-2">
                                    <div class="card border">
                                        <div class="card-body text-center"><span>4</span></div>
                                    </div>
                                </div>

                                <div class="col-md-2">
                                    <div class="card border">
                                        <div class="card-body text-center"><span>5</span></div>
                                    </div>
                                </div>

                                <div class="col-md-2">
                                    <div class="card border">
                                        <div class="card-body text-center"><span>6</span></div>
                                    </div>
                                </div>

                                <div class="col-md-2">
                                    <div class="card border">
                                        <div class="card-body text-center"><span>7</span></div>
                                    </div>
                                </div>

                                <div class="col-md-2">
                                    <div class="card border">
                                        <div class="card-body text-center"><span>8</span></div>
                                    </div>
                                </div>

                                <div class="col-md-2">
                                    <div class="card border">
                                        <div class="card-body text-center"><span>9</span></div>
                                    </div>
                                </div>

                                <div class="col-md-2">
                                    <div class="card border">
                                        <div class="card-body text-center">1<span>0</span></div>
                                    </div>
                                </div>

                                <div class="col-md-2">
                                    <div class="card border">
                                        <div class="card-body text-center">1<span>1</span></div>
                                    </div>
                                </div>

                                <div class="col-md-2">
                                    <div class="card border">
                                        <div class="card-body text-center">1<span>2</span></div>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="card border">
                                        <div class="card-body text-center">1<span>3</span></div>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="card border">
                                        <div class="card-body text-center">1<span>4</span></div>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="card border">
                                        <div class="card-body text-center">1<span>5</span></div>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="card border">
                                        <div class="card-body text-center">1<span>6</span></div>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="card border">
                                        <div class="card-body text-center">1<span>7</span></div>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="card border">
                                        <div class="card-body text-center">1<span>8</span></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-xl-6">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title"> Multiple Drag </h5>
                        </div>
                        <div class="card-body">
