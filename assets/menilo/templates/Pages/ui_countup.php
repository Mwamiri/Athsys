<?= $this->element('title_meta', ['title' => 'Advanced UI Counter']) ?>

<?= $this->element('page_title', ['title' => 'Advanced UI', 'subTitle' => 'Counter']) ?>
...
<div class="row">
    ...
    <div class="col-12">
        <div class="card card-h-100">
            <div class="card-header">
                <h5 class="card-title">Nagative Values</h5>
            </div>
            <div class="card-body">
                <p class="text-muted mb-4">Use the fields below to enter a date. Please follow the specified format for
                    each field:</p>
    ...
    <div class="col-12">
        <div class="card card-h-100">
            <div class="card-header">
                <h5 class="card-title">Decimal Values</h5>
            </div>
            <div class="card-body">
                <p class="text-muted mb-4">Use the fields below to enter a date. Please follow the specified format for
                    each field:</p>
