<?= $this->element('title_meta', ['title' => 'Billing & Subscription']) ?>

<?= $this->element('page_title', ['title' => 'Pages', 'subTitle' => 'Billing & Subscription']) ?>
  ...
  <div class="card-body">
    <div class="d-flex justify-content-between flex-wrap gap-4 align-items-center">
      <div>
        ...
        <p class="mb-0 text-muted">Higher plans offer higher message request limit, additional features, and much more.
        </p>
      </div>
  ...
  <div class="card-body">
    <div class="row g-5">
      <div class="col-xl-5">
        ...
        <p class="text-muted max-w-500px mb-5">Manage your saved payment methods by selecting a default card for
          automatic billing. You can also add new cards, update existing ones, or remove those you no longer use.</p>
        ...
        <div class="main-img-checkbox">
          <div class="card-wrapper overflow-hidden">
            <div class="img-checkbox billings-card mb-4">
              <input class="main-img-cover form-check-input float-end" type="radio" id="img-check-1" type="checkbox"
                checked>
              <label class="form-check-label mb-0 p-4" for="img-check-1">
                <span class="d-flex align-items-start gap-4 mb-3">
                  <img src="assets/images/cards/visa.png" alt="Visa" class="w-56px">
                  <span class="flex-grow-1">
                    <strong class="mb-1">Visa Ending in 1234</strong><br>
                    <small class="text-muted fs-13">Cardholder: Sarah Williams</small>
                  </span>
                </span>
                <span class="d-flex justify-content-between gap-8 align-items-center">
                  <small class="mb-0 text-muted">Expires: 10/20/2022</small>
            ...
            <div class="img-checkbox billings-card mb-4">
              ...
              <label class="form-check-label mb-0 p-4" for="img-check-2">
                <span class="d-flex align-items-start gap-4 mb-3">
                  ...
                  <span class="flex-grow-1">
                    <strong class="mb-1">MasterCard Ending in 6200</strong>
                    <small class="text-muted fs-13">Cardholder: Sarah Williams</small>
                  </span>
                </span>
                <span class="d-flex justify-content-between gap-8 align-items-center">
                  <small class="mb-0 text-muted">Expires: 11/05/2023</small>
  ...
  <div class="card-body">
    <div class="row g-5">
      <div class="col-xl-5">
        ...
        <p class="text-muted max-w-500px mb-5">You are currently subscribed to the <span
            class="fw-semibold text-primary">Basic</span> plan. This plan includes essential features for small teams
          and limited message quotas.</p>
        ...
        <div class="progress progress-sm" style="width: 75%" role="progressbar" aria-label="Basic example"
      ...
      <div class="col-xl-7">
        <div class="main-img-checkbox">
          <div class="card-wrapper overflow-hidden">
            <div class="img-checkbox billings-card mb-4">
              <input class="main-img-cover form-check-input float-end" type="radio" id="img-check-3" type="checkbox"
                checked>
              <label class="form-check-label mb-0 p-4" for="img-check-3">
                <span class="d-flex justify-content-between align-items-start mb-3">
                  <span>
                    <strong class="mb-1">Basic Plan</strong>
                    <small class="text-muted fs-13"><strong class="text-body">$19.00</strong>/Monthly</small>
                  </span>
                </span>
                <span class="d-flex justify-content-between gap-8 align-items-center">
                  <span class="mb-0 text-muted text-truncate">Renews on: 05/25/2025</span>
            ...
            <div class="img-checkbox billings-card mb-4">
              ...
              <label class="form-check-label mb-0 p-4" for="img-check-4">
                <span class="d-flex justify-content-between align-items-start mb-2">
                  <span>
                    <strong class="mb-1">Pro Plan</strong>
                    <small class="text-muted fs-13"><strong class="text-body">$49.00</strong>/Monthly</small>
                  </span>
                </span>
                <span class="d-flex justify-content-between gap-8 align-items-center">
                  <small class="mb-0 text-muted text-truncate">Ideal for growing teams needing additional quota and
                    advanced support.</small>
  ...
  <div class="card-body">
    <div class="row justify-content-between g-5">
      <div class="col-xl-5">
        ...
        <p class="text-muted max-w-500px mb-5">Please provide the contact person we should reach out to in case we need
          to verify account activity, send billing notifications.</p>
...
<div class="card">
  <div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-4">
    ...
    <div class="d-flex flex-wrap gap-3">
      ...
      <button type="button" class="btn btn-light-success"><i class="bi bi-funnel me-1"></i> Filter</button>
      <button type="button" class="btn btn-light-info"><i class="bi bi-funnel me-1"></i> Export</button>
    </div>
  </div>
  <div class="card-body">
    <div class="table-box table-responsive">
      <table class="table align-middle text-nowrap mb-0">
        ...
        <tbody>
          <tr>
            <td><a href="#!" class="text-body">#EN-1001</a></td>
            <td class="d-flex align-items-center gap-3">
              <img src="assets/images/avatar/avatar-1.jpg" alt="Avtar Image" class="avatar-md rounded-pill">
              <div>
                <a href="#!" class="mb-1 text-body fw-medium">Web Development Bootcamp</a>
          ...
          <tr>
            <td><a href="#!" class="text-body">#EN-1002</a></td>
            <td class="d-flex align-items-center gap-3">
              <img src="assets/images/avatar/avatar-2.jpg" alt="Avtar Image" class="avatar-md rounded-pill">
              <div>
                <a href="#!" class="mb-1 text-body fw-medium">Fullstack Developer Course</a>
          ...
          <tr>
            <td><a href="#!" class="text-body">#EN-1003</a></td>
            <td class="d-flex align-items-center gap-3">
              <img src="assets/images/avatar/avatar-3.jpg" alt="Avtar Image" class="avatar-md rounded-pill">
              <div>
                <a href="#!" class="mb-1 text-body fw-medium">UI/UX Design Masterclass</a>
          ...
          <tr>
            <td><a href="#!" class="text-body">#EN-1004</a></td>
            <td class="d-flex align-items-center gap-3">
              <img src="assets/images/avatar/avatar-4.jpg" alt="Avtar Image" class="avatar-md rounded-pill">
              <div>
                <a href="#!" class="mb-1 text-body fw-medium">Data Science Bootcamp</a>
          ...
          <tr>
            <td><a href="#!" class="text-body">#EN-1005</a></td>
            <td class="d-flex align-items-center gap-3">
              <img src="assets/images/avatar/avatar-5.jpg" alt="Avtar Image" class="avatar-md rounded-pill">
              <div>
                <a href="#!" class="mb-1 text-body fw-medium">React.js Advanced</a>
          ...
          <tr>
            <td><a href="#!" class="text-body">#EN-1006</a></td>
            <td class="d-flex align-items-center gap-3">
              <img src="assets/images/avatar/avatar-6.jpg" alt="Avtar Image" class="avatar-md rounded-pill">
              <div>
                <a href="#!" class="mb-1 text-body fw-medium">Python for Beginners</a>
    ...
    <div class="d-flex flex-wrap gap-3 align-items-center mt-5">
      <p class="mb-0"> Showing 1 - 6 of 25 Entries</p>
      <div class="ms-auto">
        <nav aria-label="Page navigation example">
          <ul class="pagination pagination-primary mb-0">
            <li class="page-item">
              <a class="page-link page-prev" href="#">Prev</a>
            </li>
