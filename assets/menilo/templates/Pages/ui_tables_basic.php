<?= $this->element('title_meta', ['title' => 'Basic Tables']) ?>

<?= $this->element('page_title', ['title' => 'Base UI', 'subTitle' => 'Basic Tables']) ?>
...
<div class="row">
    ...
    <div class="col-12 col-xl-6">
        <div class="card card-h-100">
            ...
            <div class="card-body">
                <p class="text-muted mb-4">The basic table in Bootstrap is created using the <code>&lt;table&gt;</code>
                    element with the <code>.table</code> class. This class adds basic styling like borders, padding, and
                    hover effects to make the table look clean and organized.</p>
                <!-- start:: Basic Table -->
        ...
        <div class="card card-h-100">
            ...
            <div class="card-body">
                <p class="text-muted mb-4">A bordered table in Bootstrap is created by adding the
                    <code>.table-bordered</code> class to a <code>&lt;table&gt;</code>. This adds borders around all the
                    table cells, making each row and column more distinct.
                </p>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="hstack gap-3">
                                        <button type="button" class="btn btn-light-primary border-primary icon-btn-sm"
                                            data-bs-toggle="tooltip" data-bs-custom-class="tooltip-white"
                                            data-bs-placement="top" data-bs-title="Edit">
                                            <i class="ri-edit-2-line"></i>
                                        </button>
                                        <button type="button" class="btn btn-light-danger border-danger icon-btn-sm"
                                            data-bs-toggle="tooltip" data-bs-custom-class="tooltip-white"
    ...
    <div class="col-12">
        <div class="card card-h-100">
            <!--start::card-->
            <div class="card-header">
                <h5 class="card-title"> Borderedless Table </h5>
            </div>
            <div class="card-body">
                <p class="text-muted mb-4">The <strong>Borderless Table</strong> in Bootstrap removes all table borders,
                    providing a clean and minimal design. Use the <code>.table-borderless</code> class to apply this
                    style to your table.</p>
                    ...
                    <table class="table text-nowrap table-borderless mb-0">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>$150</td>
                                <td><i class="ri-checkbox-circle-line align-middle text-success"></i> In Stock</td>
                                <td><span class="text-success fw-semibold">5% <i class="ri-arrow-up-line"></i></span>
                                </td>
                                <td>
                                    <div class="dropdown">
                                        <button class="btn btn-light-primary icon-btn" type="button" id="actionMenu1"
                            ...
                            <tr>
                                ...
                                <td>$999</td>
                                <td><i class="ri-close-circle-line align-middle text-danger"></i> Out of Stock</td>
                                <td><span class="text-danger fw-semibold">3% <i class="ri-arrow-down-line"></i></span>
                                </td>
                                <td>
                                    <div class="dropdown">
                                        <button class="btn btn-light-primary icon-btn" type="button" id="actionMenu2"
                                            data-bs-toggle="dropdown" aria-expanded="false">
                                            <i class="ri-more-2-line fw-semibold fs-16"></i>
                                        </button>
                            ...
                            <tr>
                                ...
                                <td>$1,200</td>
                                <td><i class="ri-checkbox-circle-line align-middle text-success"></i> In Stock</td>
                                <td><span class="text-success fw-semibold">10% <i class="ri-arrow-up-line"></i></span>
                                </td>
                                <td>
                                    <div class="dropdown">
                                        <button class="btn btn-light-primary icon-btn" type="button" id="actionMenu3"
                                            data-bs-toggle="dropdown" aria-expanded="false">
                                            <i class="ri-more-2-line fw-semibold fs-16"></i>
                                        </button>
                            ...
                            <tr>
                                ...
                                <td>$250</td>
                                <td><i class="ri-checkbox-circle-line align-middle text-success"></i> In Stock</td>
                                <td><span class="text-success fw-semibold">8% <i class="ri-arrow-up-line"></i></span>
                                </td>
                                <td>
                                    <div class="dropdown">
                                        <button class="btn btn-light-primary icon-btn" type="button" id="actionMenu4"
                                            data-bs-toggle="dropdown" aria-expanded="false">
                                            <i class="ri-more-2-line fw-semibold fs-16"></i>
                                        </button>
    ...
    <div class="col-12">
        <div class="card card-h-100">
            <!--start::card-->
            <div class="card-header">
                <h5 class="card-title"> Table Striped Column </h5>
            </div>
            <div class="card-body">
                <p class="text-muted mb-4">The <strong>Striped Column Table</strong> in Bootstrap adds alternating
                    ...
                    <code>.table-striped-columns</code> class to apply this effect.
                </p>
    ...
    <div class="col-12 col-xl-6">
        <div class="card card-h-100">
            ...
            <div class="card-body">
                <p class="text-muted mb-4">The <strong>Hoverable Rows Table</strong> in Bootstrap highlights table rows
                    when hovered. Use the <code>.table-hover</code> class to apply this effect.</p>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex gap-2 align-items-center">
                                        <div class="flex-shrink-0">
                                            <img src="https://dash-tail.vercel.app/_next/static/media/avatar-1.f70409c3.jpg"
                                                alt="John Doe" class="avatar-item border-0 avatar-md rounded-circle">
                                        </div>
                                        <div class="flex-grow-1">
                                            <h6 class="m-0 lh-1">John Doe</h6>
                                            <div class="lh-1"><span class="fs-11 text-muted">john.doe@example.com</span>
                                            </div>
                                        </div>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex gap-2 align-items-center">
                                        <div class="flex-shrink-0">
                                            <img src="https://dash-tail.vercel.app/_next/static/media/avatar-1.f70409c3.jpg"
                                                alt="Jane Smith" class="avatar-item border-0 avatar-md rounded-circle">
                                        </div>
                                        <div class="flex-grow-1">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex gap-2 align-items-center">
                                        <div class="flex-shrink-0">
                                            <img src="https://dash-tail.vercel.app/_next/static/media/avatar-1.f70409c3.jpg"
                                                alt="Chris Evans" class="avatar-item border-0 avatar-md rounded-circle">
                                        </div>
                                        <div class="flex-grow-1">
        ...
        <div class="card card-h-100">
            ...
            <div class="card-body">
                <p class="text-muted mb-4">The <strong>Table Dark</strong> example in Bootstrap uses the
                    <code>.table-dark</code> class to apply a dark background to the table, making the text stand out
                    with lighter colors.
                </p>
                <!-- start:: Table Dark -->
                <div class="table-responsive">
    ...
    <div class="col-12 col-xl-6">
        <div class="card card-h-100">
            <!--start::card-->
            <div class="card-header">
                <h5 class="card-title"> Table Primary </h5>
            </div>
            <div class="card-body">
                <p class="text-muted mb-4">The <strong>Table Primary</strong> example in Bootstrap applies the
                    <code>.table-primary</code> class to give the table a blue background, following the primary theme
                    color for a highlighted look.
                </p>
                <!-- start:: Table Primary -->
                <div class="table-responsive">
    ...
    <div class="col-12 col-xl-6">
        <div class="card card-h-100">
            ...
            <div class="card-body">
                <p class="text-muted mb-4">The <strong>Active Table</strong> example in Bootstrap adds an active state
                    to a specific row or cell using the <code>.table-active</code> class. This highlights the selected
                    row or cell with a gray background.</p>
                <!-- start:: Active Table -->
                <div class="table-responsive">
    ...
    <div class="col-12 col-xl-6">
        <div class="card card-h-100">
            <!--start::card-->
            <div class="card-header">
                <h5 class="card-title"> Table Small </h5>
            </div>
            <div class="card-body">
                <p class="text-muted mb-4">The <strong>Table Small</strong> example in Bootstrap uses the
                    ...
                    more condensed, ideal for displaying data in a smaller footprint.
                </p>
                <!-- start:: Table Small -->
                <div class="table-responsive">
    ...
    <div class="col-12">
        <div class="card card-h-100">
            ...
            <div class="card-body">
                <p class="text-muted mb-4">The <strong>Vertical Alignment</strong> example in Bootstrap demonstrates how
                    to align table cell content vertically. You can use classes like <code>.align-top</code>,
                    <code>.align-middle</code>, and <code>.align-bottom</code> to position content at the top, middle,
                    or bottom of the cell, enhancing the table's readability and organization.
                </p>
    ...
    <div class="col-12">
        <div class="card card-h-100">
            <!--start::card-->
            <div class="card-header">
                <h5 class="card-title"> Nested Table </h5>
            </div>
            <div class="card-body">
                <p class="text-muted mb-4">The <strong>Nested Table</strong> example in Bootstrap shows how to create a
                    table within another table. This allows you to organize complex data hierarchically. You can use the
                    same Bootstrap table classes to style the nested table, ensuring a consistent look while presenting
                    detailed information effectively.</p>
                <!-- start:: Nested Table -->
                <div class="table-responsive">
                                ...
                                <td>
                                    <table class="table table-info table-bordered m-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>Sub-item 2A</td>
                                                <td>This sub-item covers the performance metrics of the item, including
                                                    speed, efficiency, and reliability.</td>
                                            </tr>
                                            <tr>
                                                <td>Sub-item 2B</td>
                                                <td>Detailed analysis of user experiences, common issues, and customer
                                                    support options.</td>
                                            </tr>
                                        </tbody>
                                    </table>
    ...
    <div class="col-12">
        <div class="card">
            <!--start::card-->
            <div class="card-header">
                <h5 class="card-title"> Table Anatomy </h5>
            </div>
            <div class="card-body">
                <p class="text-muted mb-4">The <strong>Table Anatomy</strong> example in Bootstrap illustrates the basic
                    structure of a table. It includes essential elements like the table header
                    <code>&lt;thead&gt;</code>, body <code>&lt;tbody&gt;</code>, and footer <code>&lt;tfoot&gt;</code>,
                    showcasing how to organize data in a clear and readable format.</p>
                <!-- start:: Table Anatomy -->
                <div class="table-responsive">
                    <table class="table table-striped table-hover mb-0">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>Developer</td>
                                <td>@mdo</td>
                                <td>Passionate about coding and open-source contributions. Enjoys hiking in his spare
                                    time.</td>
                            </tr>
                            <tr>
                                <th scope="row">2</th>
                        ...
                        <tfoot>
                            <tr>
                                <td colspan="5" class="text-center">Join our community and connect with these amazing
                                    individuals!</td>
                            </tr>
                        </tfoot>
                    </table>
