<?= $this->element('title_meta', ['title' => 'UI Accordions']) ?>

<!-- prism css -->
<link rel="stylesheet" href="assets/libs/prismjs/themes/prism-coy.min.css" />

<?= $this->element('page_title', ['title' => 'Base UI', 'subTitle' => 'Accordions']) ?>
                    ...
                    <div class="tab-pane fade show active" id="html-basic-accordion" role="tabpanel"
                        ...
                        <div class="accordion" id="accordionExample">
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        data-bs-target="#demo_accordion_item_02" aria-expanded="false"
                                        aria-controls="demo_accordion_item_02">
                                        Accordion Item #2
                                    </button>
                                </h2>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        data-bs-target="#demo_accordion_item_03" aria-expanded="false"
                                        aria-controls="demo_accordion_item_03">
                                        Accordion Item #3
                                    </button>
                                </h2>
                    ...
                    <div class="tab-pane fade show active" id="html-flush-accordion" role="tabpanel"
                        ...
                        <div class="accordion accordion-flush" id="demo_accordion_main_02">
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        data-bs-target="#demo_accordion_item_12" aria-expanded="false"
                                        aria-controls="demo_accordion_item_12">
                                        Accordion Item #2
                                    </button>
                                </h2>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        data-bs-target="#demo_accordion_item_13" aria-expanded="false"
                                        aria-controls="demo_accordion_item_13">
                                        Accordion Item #3
                                    </button>
                                </h2>
...
&lt;/div&gt;</code></pre>
    ...
    <div class="col-12 col-xl-6">
        <div class="card card-h-100">
            <div class="card-header">
                <h5 class="card-title">Accordions with Icons</h5>
                    ...
                    <div class="tab-pane fade show active" id="html-icon-with-accordion" role="tabpanel"
                        ...
                        <div class="accordion accordion-icon" id="demo_accordion_main_03">
                            <div class="accordion-item">
                                ...
                                <div id="demo_accordion_item_31" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">
                                        ...
                                        a website or application that users interact with. This includes designing and
                                        implementing user interfaces (UI) using HTML, CSS, and JavaScript. For example,
                                        using Bootstrap to quickly style and layout responsive components can
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        data-bs-target="#demo_accordion_item_32" aria-expanded="false"
                                        aria-controls="demo_accordion_item_32">
                                ...
                                <div id="demo_accordion_item_32" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">
                                        ...
                                        powers the functionalities behind the scenes of a website or application. This
                                        includes working with databases, server logic, and APIs. For instance, using
                                        frameworks like Node.js or Django helps in efficiently managing server-side
                                        operations and handling data interactions.
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                <h2 class="accordion-header">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        data-bs-target="#demo_accordion_item_33" aria-expanded="false"
                                        aria-controls="demo_accordion_item_33">
                                ...
                                <div id="demo_accordion_item_33" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">
                                        ...
                                        default Bootstrap variables using custom CSS, or utilizing the Bootstrap theme
                                        customizer. For example, you can adjust the color scheme and spacing of
                                        Bootstrap components to align with your branding guidelines and improve the
...
&lt;/div&gt;</code></pre>
    ...
    <div class="col-12 col-xl-6">
        <div class="card card-h-100">
            <div class="card-header">
                <h5 class="card-title">Accordions without Icons</h5>
                <ul class="nav nav-pills nav-preview nav-primary mb-0" id="icon-without-accordion" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="html-icon-without-accordion-tab" data-bs-toggle="pill"
                            data-bs-target="#html-icon-without-accordion" type="button" role="tab"
                            aria-controls="html-icon-without-accordion" aria-selected="true">HTML</button>
                    </li>
                    <li class="nav-item" role="presentation">
            ...
            <div class="card-body">
                <p class="text-muted">Use the <code>.accordion-icon-none</code> class to create Bootstrap accordions
                    <strong>without icons</strong>. This class hides any default icons, giving your accordion a cleaner
                    look.</p>
                    ...
                    <div class="tab-pane fade show active" id="html-icon-without-accordion" role="tabpanel"
                        ...
                        <div class="accordion accordion-icon-none" id="demo_accordion_main_04">
                            <div class="accordion-item">
                                <h2 class="accordion-header">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        data-bs-target="#demo_accordion_item_41" aria-expanded="true"
                                        aria-controls="demo_accordion_item_41">
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        data-bs-target="#demo_accordion_item_42" aria-expanded="false"
                                        aria-controls="demo_accordion_item_42">
                                        <i class="ri-braces-line me-2"></i> Backend Development
                                    </button>
                                </h2>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        data-bs-target="#demo_accordion_item_43" aria-expanded="false"
                                        aria-controls="demo_accordion_item_43">
                                        <i class="ri-paint-brush-line me-2"></i> Bootstrap Customizations
                                    </button>
                                </h2>
...
&lt;/div&gt;</code></pre>
    ...
    <div class="col-12 col-xl-6">
        <div class="card card-h-100">
            <div class="card-header">
                <h5 class="card-title">Accordions with Plus Icon</h5>
                <ul class="nav nav-pills nav-preview nav-primary mb-0" id="plus-icon-with-accordion" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="html-plus-icon-with-accordion-tab" data-bs-toggle="pill"
                            data-bs-target="#html-plus-icon-with-accordion" type="button" role="tab"
                            aria-controls="html-plus-icon-with-accordion" aria-selected="true">HTML</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="preview-plus-icon-with-accordion-tab" data-bs-toggle="pill"
                            ...
                            aria-controls="preview-plus-icon-with-accordion" aria-selected="false">Preview</button>
                    </li>
                </ul>
            </div>
            <div class="card-body">
...
&lt;/div&gt;</code></pre>
    ...
    <div class="col-12 col-xl-6">
        <div class="card card-h-100">
            <div class="card-header">
                <h5 class="card-title">Accordions with Left Icon with Plus Icon</h5>
                <ul class="nav nav-pills nav-preview nav-primary mb-0" id="left-plus-icon-with-accordion"
                    role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="html-left-plus-icon-with-accordion-tab"
                            data-bs-toggle="pill" data-bs-target="#html-left-plus-icon-with-accordion" type="button"
                            role="tab" aria-controls="html-left-plus-icon-with-accordion"
                            aria-selected="true">HTML</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="preview-left-plus-icon-with-accordion-tab" data-bs-toggle="pill"
                            data-bs-target="#preview-left-plus-icon-with-accordion" type="button" role="tab"
                            aria-controls="preview-left-plus-icon-with-accordion" aria-selected="false">Preview</button>
                    </li>
                </ul>
            </div>
            <div class="card-body">
                <p class="text-muted">Use the <code>.accordion-with-left-icon</code> class to add an <strong>icon on the
                        left</strong> of each accordion item. Place your icon in an <code>&lt;i&gt;</code> tag within
                    the <code>.accordion-header</code>.</p>
                <div class="tab-content" id="left-plus-icon-with-accordionContent">
                    <div class="tab-pane fade show active" id="html-left-plus-icon-with-accordion" role="tabpanel"
                        aria-labelledby="html-left-plus-icon-with-accordion-tab" tabindex="0">
                        <div class="accordion accordion-with-plus accordion-with-left-icon" id="demo_accordion_main_07">
                            <div class="accordion-item">
                                <h2 class="accordion-header">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        data-bs-target="#demo_accordion_item_71" aria-expanded="true"
                                        aria-controls="demo_accordion_item_71">
                                        Frontend Development
                                    </button>
                                </h2>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        data-bs-target="#demo_accordion_item_72" aria-expanded="false"
                                        aria-controls="demo_accordion_item_72">
                                        Backend Development
                                    </button>
                                </h2>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        data-bs-target="#demo_accordion_item_73" aria-expanded="false"
                                        aria-controls="demo_accordion_item_73">
...
&lt;/div&gt;</code></pre>
    ...
    <div class="col-12 col-xl-6">
        <div class="card card-h-100">
            <div class="card-header">
                <h5 class="card-title">Accordions with theme color</h5>
            ...
            <div class="card-body">
                <p class="text-muted">Customize your Bootstrap accordion header with <strong>theme colors</strong> by
                    applying classes like <code>.accordion-primary</code> or <code>.text-white</code>.</p>
                    ...
                    <div class="tab-pane fade show active" id="html-theme-color-accordion" role="tabpanel"
                        ...
                        <div class="accordion accordion-primary accordion-border-box" id="demo_accordion_main_08">
                            <div class="accordion-item">
                                <h2 class="accordion-header">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        data-bs-target="#demo_accordion_item_81" aria-expanded="true"
                                        aria-controls="demo_accordion_item_81">
                                        Frontend Development
                                    </button>
                                </h2>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        data-bs-target="#demo_accordion_item_82" aria-expanded="false"
                                        aria-controls="demo_accordion_item_82">
                                        Backend Development
                                    </button>
                                </h2>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        data-bs-target="#demo_accordion_item_83" aria-expanded="false"
                                        aria-controls="demo_accordion_item_83">
                                        Bootstrap Customizations
                                    </button>
                                </h2>
...
&lt;/div&gt;</code></pre>
    ...
    <div class="col-12 col-xl-6">
        <div class="card card-h-100">
            <div class="card-header">
                <h5 class="card-title">Accordions with subtitle</h5>
                <ul class="nav nav-pills nav-preview nav-primary mb-0" id="subtitle-with-accordion" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="html-subtitle-with-accordion-tab" data-bs-toggle="pill"
                            data-bs-target="#html-subtitle-with-accordion" type="button" role="tab"
                            aria-controls="html-subtitle-with-accordion" aria-selected="true">HTML</button>
                    </li>
                    <li class="nav-item" role="presentation">
...
&lt;/div&gt;</code></pre>
    ...
    <div class="col-12">
        <div class="card card-h-100">
            <div class="card-header">
                <h5 class="card-title">Accordion With Content</h5>
                <ul class="nav nav-pills nav-preview nav-primary mb-0" id="content-with-accordion" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="html-content-with-accordion-tab" data-bs-toggle="pill"
                            data-bs-target="#html-content-with-accordion" type="button" role="tab"
                            aria-controls="html-content-with-accordion" aria-selected="true">HTML</button>
                    </li>
                    <li class="nav-item" role="presentation">
            ...
            <div class="card-body">
                <p class="text-muted">You can create an <strong>accordion with images</strong> in Bootstrap by including
                    <code>&lt;img&gt;</code> tags within the <code>.accordion-header</code> section. This lets you
                    display images alongside text content, enhancing visual appeal and information delivery.</p>
...
&lt;/div&gt;</code></pre>
    ...
    <div class="col-12">
        <div class="card card-h-100">
            <div class="card-header">
                <h5 class="card-title">Nesting Accordions</h5>
            </div>
            <div class="card-body">
                <p class="text-muted">With Bootstrap, you can create <strong>nested accordions</strong> to organize
                    content hierarchically. To do this, simply place an <code>&lt;accordion&gt;</code> component inside
                    another <code>&lt;accordion&gt;</code>. Make sure each nested accordion has a unique <code>ID</code>
                            ...
                            <div class="accordion-body">
                                ...
                                <div class="accordion" id="frontend_steps">
                                    ...
                                    <div class="accordion-item">
                                        <h2 class="accordion-header">
                                            <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                                data-bs-target="#frontend_step_1" aria-expanded="true"
                                                aria-controls="frontend_step_1">
                                        ...
                                        <div id="frontend_step_1" class="accordion-collapse collapse show"
                                            ...
                                            <div class="accordion-body">
                                                Set up your development environment by installing necessary tools and
                                                frameworks like Node.js, npm, and a code editor.
                                                ...
                                                <div class="accordion mt-3" id="frontend_setup_details">
                                                    <div class="accordion-item">
                                                        ...
                                                        <div id="frontend_setup_step_1"
                                                            ...
                                                            <div class="accordion-body">
                                                                Install tools such as Node.js, npm, and any code editor
                                                                like VSCode.
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="accordion-body">
                                                ...
                                                <div class="accordion mt-3" id="backend_api_details">
                                                    <div class="accordion-item">
                                                        ...
                                                        <div id="backend_api_step_1" class="accordion-collapse collapse"
    ...
    <div class="col-12 col-xl-6">
        <div class="card card-h-100">
            <div class="card-header">
                <h5 class="card-title">Collapse Example</h5>
                    ...
                    <div class="tab-pane fade show active" id="html-collapse-example" role="tabpanel"
                        ...
                        <div class="collapse show" id="collapseExample">
                            <div class="card card-body mb-0">
                                ...
                                <p class="card-text">
                                    Here’s some extra information that might be useful. For example, if you’re reading
                                    about a product, you could find details about its features, user instructions, or
                                    any other interesting facts. This part is hidden by default and will appear when you
                                    click either of the buttons above.
                                </p>
                            </div>
                        </div>
                    </div>
...
&lt;/div&gt;</code></pre>
    ...
    <div class="col-12 col-xl-6">
        <div class="card card-h-100">
            <div class="card-header">
                <h5 class="card-title">Horizontal Collapse</h5>
                <ul class="nav nav-pills nav-preview nav-primary mb-0" id="collapse-horizontal" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="html-collapse-horizontal-tab" data-bs-toggle="pill"
                            data-bs-target="#html-collapse-horizontal" type="button" role="tab"
                            aria-controls="html-collapse-horizontal" aria-selected="true">HTML</button>
                    </li>
                    <li class="nav-item" role="presentation">
            ...
            <div class="card-body">
                <p class="text-muted">Use the <code>collapse-horizontal</code> class to make elements slide open and
                    closed horizontally, instead of vertically. Make sure to set a specific <code>width</code> on the
                    child element that you want to collapse.</p>
...
&lt;/div&gt;</code></pre>
    ...
    <div class="col-12">
        <div class="card card-h-100">
            <div class="card-header">
                <h5 class="card-title">Collapse with Icon</h5>
                ...
                <div class="tab-content" id="collapse-with-iconContent">
                    <div class="tab-pane fade show active" id="html-collapse-with-icon" role="tabpanel"
                        ...
                        <div class="d-flex flex-wrap gap-5 align-items-center mb-3">
                            ...
                            <div class="custom-toggle fw-semibold d-flex align-items-center" data-bs-toggle="collapse"
                        ...
                        <div class="collapse show" id="collapseContent">
                            <div class="card card-body mb-0">
                                This is some detailed content that gets revealed when you click "Read More" and hidden
                                when you click "Read Less". Customize this text as needed for your application.
                            </div>
                        </div>
                    </div>
...
&lt;/div&gt;</code></pre>
    ...
    <div class="col-12">
        <div class="card card-h-100">
            <div class="card-header">
                <h5 class="card-title">Controlling Multiple Collapses</h5>
            ...
            <div class="card-body">
                <p class="text-muted">
                    You can use a <code>&lt;button&gt;</code> or <code>&lt;a&gt;</code> to control multiple collapsible
                    elements at once by using the same <code>data-bs-target</code> or <code>href</code> attribute.
                    Similarly, a single <code>&lt;button&gt;</code> or <code>&lt;a&gt;</code> can control multiple
                    collapsible elements if you use the same attribute value for all.
                </p>
                <div class="tab-content" id="collapse-multipleContent">
                    <div class="tab-pane fade show active" id="html-collapse-multiple" role="tabpanel"
                        ...
                        <div class="d-inline-flex gap-2 mb-3">
                            <a class="btn btn-primary" data-bs-toggle="collapse" href="#collapseOne" role="button"
                                aria-expanded="false" aria-controls="collapseOne">Toggle First Section</a>
                            <button class="btn btn-primary" type="button" data-bs-toggle="collapse"
                                data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">Toggle
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="collapse show multi-collapse" id="collapseOne">
                                    <div class="card card-body mb-0">
                                        This is the content for the first section. It’s hidden by default and will be
                                        shown when the appropriate button is clicked.
                                    </div>
                                </div>
                            </div>
                            <div class="col">
                                <div class="collapse show multi-collapse" id="collapseTwo">
                                    <div class="card card-body mb-0">
                                        This is the content for the second section. It’s hidden by default and will be
                                        shown when the appropriate button is clicked.
                                    </div>
                                </div>
                            </div>
