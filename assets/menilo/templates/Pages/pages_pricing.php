...
<?= $this->element('page_title', ['title' => 'Page', 'subTitle' => 'Pricing']) ?>
        ...
        <div class="card mb-0 overflow-hidden">
          <div class="card-body">
            ...
            <ul class="list-unstyled fs-15">
              ...
              <li class="mb-5"><i class="bi bi-check-lg me-2 text-primary"></i><span>Advanced reporting tools.</span>
              </li>
              <li class="mb-5"><i class="bi bi-check-lg me-2 text-primary"></i><span>Priority email support.</span></li>
              <li class="mb-5"><i class="bi bi-check-lg me-2 text-primary"></i><span>Enhanced security options.</span>
              </li>
      ...
      <div class="col-12 col-md-6 col-xl-3">
        <div class="card mb-0 overflow-hidden">
          <div class="card-body">
            ...
            <ul class="list-unstyled fs-15">
              <li class="mb-5"><i class="bi bi-check-lg me-2 text-primary"></i><span>Unlimited users & teams.</span>
              </li>
              <li class="mb-5"><i class="bi bi-check-lg me-2 text-primary"></i><span>Custom advanced features.</span>
              </li>
              ...
              <li class="mb-5"><i class="bi bi-check-lg me-2 text-primary"></i><span>Daily backups & reports.</span>
              </li>
              <li class="mb-5"><i class="bi bi-check-lg me-2 text-primary"></i><span>Roadmap priority access.</span>
              </li>
            </ul>
          </div>
        </div>
  ...
  <div class="col-12">
    ...
    <ul class="nav nav-pills p-2 bg-primary-subtle rounded w-max mx-auto" role="tablist">
      <li class="nav-item" role="presentation">
        <a class="nav-link active" data-bs-toggle="tab" href="#monthly-pricing" role="tab" aria-selected="false"
          tabindex="-1">
          <span>Monthly</span>
        </a>
      </li>
            ...
            <div class="card mb-0 overflow-hidden">
              <div class="card-body">
                ...
                <ul class="list-unstyled text-body fs-15 text-center">
                  <li class="mb-4"><i class="bi bi-check-lg me-2 text-primary"></i><span>Made for small teams and solo
                      users.</span></li>
                  <li class="mb-4"><i class="bi bi-check-lg me-2 text-primary"></i><span>Includes key tools with usage
                      limits.</span></li>
                  <li class="mb-4"><i class="bi bi-check-lg me-2 text-primary"></i><span>Supports 1–2 users per
                      account.</span></li>
                  <li class="mb-4 text-muted"><i class="bi bi-x me-2"></i><span>Storage and bandwidth are
                      limited.</span></li>
                  <li class="mb-4 text-muted"><i class="bi bi-x me-2"></i><span>Email help during business hours.</span>
                  </li>
                  <li class="mb-4 text-muted"><i class="bi bi-x me-2"></i><span>Works with main tools and
                      services.</span></li>
                  <li class="mb-4 text-muted"><i class="bi bi-x me-2"></i><span>Core features updated for free.</span>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div class="col-12 col-xl-4 col-xxl-3">
            <div class="card mb-0 ribbon right overflow-hidden">
              ...
              <div class="card-body">
                ...
                <ul class="list-unstyled text-body fs-15 text-center">
                  <li class="mb-4"><i class="bi bi-check-lg me-2 text-primary"></i><span>Supports up to 5 users.</span>
                  </li>
                  <li class="mb-4"><i class="bi bi-check-lg me-2 text-primary"></i><span>Essential tools
                      unlocked.</span></li>
                  <li class="mb-4"><i class="bi bi-check-lg me-2 text-primary"></i><span>Basic analytics and
                      insights.</span></li>
            ...
            <div class="card mb-0 overflow-hidden">
              <div class="card-body">
                ...
                <ul class="list-unstyled fs-15 mx-auto text-center">
                  ...
                  <li class="mb-4"><i class="bi bi-check-lg me-2 text-primary"></i><span>Advanced reporting
                      tools.</span></li>
                  <li class="mb-4"><i class="bi bi-check-lg me-2 text-primary"></i><span>Priority email support.</span>
                  </li>
                  <li class="mb-4"><i class="bi bi-check-lg me-2 text-primary"></i><span>Enhanced security
                      options.</span></li>
                  <li class="mb-4 text-muted"><i class="bi bi-x me-2"></i><span>Dedicated manager not included.</span>
                  </li>
