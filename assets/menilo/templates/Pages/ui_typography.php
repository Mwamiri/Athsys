<?= $this->element('title_meta', ['title' => 'UI Typography']) ?>

<?= $this->element('page_title', ['title' => 'Base UI', 'subTitle' => 'Typography']) ?>

<div class="row">
    <div class="col-xl-6">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">Font Family</h5>
            </div>
            <div class="card-body">
                <div class="row">
    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">Left Aligned Blockquote</h5>
            </div>
            <div class="card-body">
                <figure class="mb-0">
    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">Right Aligned Blockquote</h5>
            </div>
            <div class="card-body">
    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">Center Aligned Blockquote</h5>
            </div>
            <div class="card-body">
    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">Custom Blockquote</h5>
            </div>
            <div class="card-body">
                <div class="row g-4">
                    <div class="col-xl-6">
                    ...
                    <div class="col-xl-6">
                        <figure class="mb-0 blockquote-boxed blockquote-danger">
                            <blockquote class="blockquote">
                                <p>"The barriers to our future success are created by the uncertainties we hold today."
                                </p>
                            </blockquote>
                            <figcaption class="blockquote-footer mb-0">
                                Franklin D. Roosevelt in <cite title="Source Title">The Great Depression</cite>
                    ...
                    <div class="col-xl-6">
                        <figure class="mb-0 blockquote-boxed blockquote-warning">
                            <blockquote class="blockquote">
                                <p>"The only thing standing between us and our future achievements is the uncertainty."
                                </p>
                            </blockquote>
                            <figcaption class="blockquote-footer mb-0">
                                Franklin D. Roosevelt in <cite title="Source Title">The Great Depression</cite>
