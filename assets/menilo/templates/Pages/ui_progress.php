<?= $this->element('title_meta', ['title' => 'UI Progress']) ?>

<!-- prism css -->
<link rel="stylesheet" href="assets/libs/prismjs/themes/prism-coy.min.css" />

<?= $this->element('page_title', ['title' => 'Base UI', 'subTitle' => 'Progress']) ?>
        ...
        <div class="card card-h-100">
            ...
            <div class="card-body">
                <p class="text-muted">Create a <strong>progress bar</strong> with Bootstrap using
                    <code>.progress</code>and <code>.progress-bar</code> classes. Set the width of the progress bar with
                    inline styles or utility classes to show progress.
                </p>
...
&lt;/div&gt;</code></pre>
    ...
    <div class="col-12 col-xl-6">
        <div class="card card-h-100">
            ...
            <div class="card-body">
                <p class="text-muted">Use <strong>colored progress bars</strong> in Bootstrap by applying classes like
                    <code>.bg-success</code> or <code>.bg-danger</code> to the <code>.progress-bar</code> for different
                    colors.
                </p>
...
&lt;/div&gt;</code></pre>
    ...
    <div class="col-12 col-xl-6">
        <div class="card card-h-100">
            ...
            <div class="card-body">
                <p class="text-muted">Display <strong>labels</strong> on Bootstrap progress bars by adding text inside
                    the <code>&lt;div class="progress-bar"&gt;</code>. Use classes like <code>.text-white</code> for
                    text color.</p>
...
&lt;/div&gt;</code></pre>
    ...
    <div class="col-12 col-xl-6">
        <div class="card card-h-100">
            <div class="card-header">
                <h5 class="card-title">Progress size</h5>
            ...
            <div class="card-body">
                <p class="text-muted">Easily adjust the size of progress bars using custom classes. The
                    <code>.progress-xs</code> class represents an extra small progress bar, perfect for compact layouts.
                </p>
                <div class="tab-content" id="size-progressContent">
                    <div class="tab-pane fade show active" id="html-size-progress" role="tabpanel"
                        ...
                        <div class="d-flex flex-column gap-3">
                            ...
                            <div class="progress progress-sm" role="progressbar" aria-valuenow="25" aria-valuemin="0"
                                aria-valuemax="100">
                            ...
                            <div class="progress progress-lg" role="progressbar" aria-valuenow="75" aria-valuemin="0"
                                aria-valuemax="100">
        ...
        <div class="card card-h-100">
            ...
            <div class="card-body">
                <p class="text-muted">Create <strong>striped progress bars</strong> in Bootstrap by adding the
                    <code>.progress-bar-striped</code> class to your <code>&lt;div class="progress-bar"&gt;</code>. This
                    adds a striped pattern to the progress bar for a dynamic look.
                </p>
...
&lt;/div&gt;</code></pre>
    ...
    <div class="col-12 col-xl-6">
        <div class="card card-h-100">
            <div class="card-header">
                <h5 class="card-title">Animated Striped Progress</h5>
                <ul class="nav nav-pills nav-preview nav-primary mb-0" id="animated-striped-progress" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="html-animated-striped-progress-tab" data-bs-toggle="pill"
                            data-bs-target="#html-animated-striped-progress" type="button" role="tab"
                            aria-controls="html-animated-striped-progress" aria-selected="true">HTML</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="preview-animated-striped-progress-tab" data-bs-toggle="pill"
                            ...
                            aria-controls="preview-animated-striped-progress   " aria-selected="false">Preview</button>
                    </li>
                </ul>
            </div>
            <div class="card-body">
                <p class="text-muted">Add <strong>animation</strong> to striped progress bars in Bootstrap by using
                    <code>.progress-bar-animated</code> with <code>.progress-bar-striped</code>. This makes the stripes
...
&lt;/div&gt;</code></pre>
    ...
    <div class="col-12 col-xl-6">
        <div class="card card-h-100">
            <div class="card-header">
                <h5 class="card-title">Default Circle Progress Bar</h5>
                <ul class="nav nav-pills nav-preview nav-primary mb-0" id="default-circle-progress" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="html-default-circle-progress-tab" data-bs-toggle="pill"
                            data-bs-target="#html-default-circle-progress" type="button" role="tab"
                            aria-controls="html-default-circle-progress" aria-selected="true">HTML</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="preview-default-circle-progress-tab" data-bs-toggle="pill"
                            ...
                            aria-controls="preview-default-circle-progress   " aria-selected="false">Preview</button>
                    </li>
                </ul>
            </div>
            <div class="card-body">
                <p class="text-muted">Use the <strong>custom circle progress bar</strong> by adding a
                    ...
                    <code>&lt;circle&gt;</code> elements for the background and foreground to visually display progress.
                </p>
...
&lt;/div&gt;</code></pre>
    ...
    <div class="col-12 col-xl-6">
        <div class="card card-h-100">
            <div class="card-header">
                <h5 class="card-title">Circle Size Progress</h5>
...
&lt;/div&gt;</code></pre>
    ...
    <div class="col-12">
        <div class="card card-h-100">
            <div class="card-header">
                <h5 class="card-title">Circle Color Progress</h5>
                <ul class="nav nav-pills nav-preview nav-primary mb-0" id="color-circle-progress" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="preview-color-circle-progress-tab" data-bs-toggle="pill"
                            ...
                            aria-controls="preview-color-circle-progress   " aria-selected="false">Preview</button>
                    </li>
                </ul>
            </div>
            <div class="card-body">
                <p class="text-muted">Change the <strong>color</strong> of your circle progress bar using the
                    <code>.circular-progress-*</code> class. Apply this class to <code>.circular-progress</code> for a
                    color scheme.
                </p>
