<?= $this->element('title_meta', ['title' => 'Apex Line']) ?>

<?= $this->element('page_title', ['title' => 'Base UI', 'subTitle' => 'Apex Line']) ?>
...
<div class="row">
  ...
  <div class="col-12 col-xl-6">
    ...
    <div class="card card-h-100">
      <div class="card-body">
        ...
        <div class="toolbar">
          <button type="button" class="btn btn-sm btn-outline-secondary" id="one_month">
            1M
          </button>

          <button type="button" class="btn btn-sm btn-outline-secondary" id="six_months">
            6M
          </button>

          <button type="button" class="btn btn-sm btn-outline-secondary" id="one_year">
            1Y
          </button>

          <button type="button" class="btn btn-sm btn-outline-secondary" id="ytd">
            YTD
          </button>

          <button type="button" class="btn btn-sm btn-outline-secondary" id="all">
            ALL
          </button>
        </div>
  ...
  <div class="col-12 col-md-6 col-xl-4">
    ...
    <div class="card card-h-100">
      ...
      <div class="card-header">
        <h6 class="card-title fw-semibold">Basic Pie Chart</h6>
      </div>
      <div class="card-body">
  ...
  <div class="col-12 col-md-6 col-xl-4">
    ...
    <div class="card card-h-100">
      <div class="card-header">
        <h6 class="card-title fw-semibold">Donut Chart</h6>
      </div>
      <div class="card-body">
  ...
  <div class="col-12 col-md-6 col-xl-4">
    ...
    <div class="card card-h-100">
      <div class="card-header">
        <h6 class="card-title fw-semibold">Basic Radar Chart</h6>
      </div>
  ...
  <div class="col-12 col-md-6 col-xl-4">
    ...
    <div class="card card-h-100">
      <div class="card-header">
        <h6 class="card-title fw-semibold">Radar Multiple Chart</h6>
      </div>
      <div class="card-body">
  ...
  <div class="col-12 col-md-6 col-xl-4">
    ...
    <div class="card card-h-100">
      <div class="card-header">
        <h6 class="card-title fw-semibold">Radialbar Chart</h6>
      </div>
      <div class="card-body">
  ...
  <div class="col-12 col-md-6 col-xl-4">
    ...
    <div class="card card-h-100">
      <div class="card-header">
        <h6 class="card-title fw-semibold">Multiple Radialbar Chart</h6>
      </div>
      <div class="card-body">
