<?= $this->element('title_meta', ['title' => 'List JS Tables']) ?>

<?= $this->element('page_title', ['title' => 'Base UI', 'subTitle' => 'List JS Tables']) ?>
            ...
            <div class="row">
                ...
                <div class="col-12 col-xl-6 col-xxl-4">
                    <div class="card">
                        ...
                        <div class="card-header">
                            <h5 class="card-title"> Data Attributes + Custom </h5>
                        </div>
                        <div class="card-body">
                            <p class="text-muted mb-4">Enhance lists with <code>List.js</code> for instant search and sort using <code>data-list</code> attributes.</p>
                ...
                <div class="col-12 col-xl-6 col-xxl-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="text-muted mb-4">Use <code>List.js</code> to add search and sort features to any existing HTML list with minimal setup.</p>
                            <!-- start:: Default Navbar -->
                            <div id="existinglist">
                                <div class="input-group">
                                    <input class="search form-control" placeholder="Search" />
                ...
                <div class="col-12 col-xl-6 col-xxl-4">
                    <div class="card">
                        <!--start::card-->
                        <div class="card-header">
                            <h5 class="card-title"> Fuzzy search </h5>
                        </div>
                        <div class="card-body">
                            <p class="text-muted mb-4">Implement fuzzy search with <code>List.js</code> to match partial or misspelled input against list items dynamically.</p>
                            <!-- start:: Default Navbar -->
                            <div id="test-list">
                                <div class="input-group">
                                    <input class="search form-control" placeholder="Search" />
                ...
                <div class="col-12 col-xl-6 col-xxl-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="text-muted mb-4">Initialize a dynamic list using <code>List.js</code> with built-in search and sort capabilities, ready to populate items programmatically.</p>
                            <!-- start:: Default Navbar -->
                            <div id="new-list">
                                <div class="input-group">
                                    <input class="search form-control" placeholder="Search" />
