<?= $this->element('title_meta', ['title' => 'UI Badges']) ?>

<!-- prism css -->
<link rel="stylesheet" href="assets/libs/prismjs/themes/prism-coy.min.css">

<?= $this->element('page_title', ['title' => 'Base UI', 'subTitle' => 'Badges']) ?>
...
&lt;span class=&quot;badge bg-light text-body&quot;&gt;Light&lt;/span&gt;</code></pre>
                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title">Pill-Shaped Badge</h5>
...
&lt;span class="badge bg-light rounded-pill text-body"&gt;Light&lt;/span&gt;</code></pre>
                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title">Light Badges</h5>
...
&lt;span class=&quot;badge bg-light-subtle text-body text-body&quot;&gt;Light&lt;/span&gt;</code></pre>
                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title">Pill-Shaped Light Badges</h5>
...
&lt;span class=&quot;badge border border-light text-body&quot;&gt;Light&lt;/span&gt;</code></pre>
                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title">Pill-Shaped Outline Badges</h5>
...
&lt;/button&gt;</code></pre>
                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title">Outline Button Badges</h5>
...
&lt;/button&gt;</code>
                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title">Button Position Badges</h5>
...
&lt;/span&gt;</code></pre>
                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title">Badges with Heading</h5>
...
&lt;h6 class=&quot;mb-0&quot;&gt;Example heading &lt;span class=&quot;badge bg-primary&quot;&gt;New&lt;/span&gt;&lt;/h6&gt;</code></pre>
                ...
                <div class="col-lg-6">
                    <div class="card card-h-100">
                        <div class="card-header">
                            <h5 class="card-title">Square Badges</h5>
