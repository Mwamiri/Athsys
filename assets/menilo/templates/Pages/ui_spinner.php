<?= $this->element('title_meta', ['title' => 'UI Spinner']) ?>

<!-- prism css -->
<link rel="stylesheet" href="assets/libs/prismjs/themes/prism-coy.min.css" />

<?= $this->element('page_title', ['title' => 'Base UI', 'subTitle' => 'Spinner']) ?>
            ...
            <div class="card-header">
                ...
                <ul class="nav nav-pills nav-preview nav-primary mb-0" id="colors-grow-spinner" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="html-colors-grow-spinner-tab" data-bs-toggle="pill"
                            data-bs-target="#html-colors-grow-spinner" type="button" role="tab"
                            aria-controls="html-colors-grow-spinner" aria-selected="true">HTML</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="preview-colors-grow-spinner-tab" data-bs-toggle="pill"
                            data-bs-target="#preview-colors-grow-spinner" type="button" role="tab"
                            aria-controls="preview-colors-grow-spinner" aria-selected="false">Preview</button>
                    </li>
                </ul>
            </div>
            <div class="card-body">
                <p class="text-muted">
                    ...
                    <a href="https://getbootstrap.com/docs/5.3/utilities/colors/" target="_blank">text color
                        utilities</a>.
                </p>
                <div class="tab-content" id="colors-grow-spinnerContent">
                    <div class="tab-pane fade show active" id="html-colors-grow-spinner" role="tabpanel"
                        aria-labelledby="html-colors-grow-spinner-tab" tabindex="0">
                        <div class="spinner-border text-primary" role="status">
                            <span class="visually-hidden">Loading...</span>
                        </div>
                    </div>
                    <div class="tab-pane fade" id="preview-colors-grow-spinner" role="tabpanel"
                        aria-labelledby="preview-colors-grow-spinner-tab" tabindex="0">
...
&lt;/div&gt;</code></pre>
    ...
    <div class="col-12 col-xl-6">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">Colors Spinner</h5>
...
&lt;/div&gt;</code></pre>
    ...
    <div class="col-12 col-xl-6">
        <div class="card">
            ...
            <div class="card-body">
                <p class="text-muted">If you don’t fancy a border spinner, switch to the grow spinner. While it doesn’t
...
&lt;/div&gt;</code></pre>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">Button spinner</h5>
                ...
                <div class="tab-content" id="button-spinnerContent">
                    <div class="tab-pane fade show active" id="html-button-spinner" role="tabpanel"
                        ...
                        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
                            ...
                            <div class="d-flex flex-wrap align-items-center gap-3">
                                <button class="btn btn-success icon-btn text-success bg-success-subtle" type="button"
                                    disabled>
                                    <span class="spinner-border spinner-border-sm" aria-hidden="true"></span>
                                    <span class="visually-hidden" role="status">Loading...</span>
                                </button>
...
&lt;/div&gt;</code></pre>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">Spinner Sizes</h5>
            ...
            <div class="card-body">
                <p class="text-muted">Display different sizes of spinners using utility classes or inline styles to
                    visually indicate loading or processing states. Combine with color classes to represent various
                    statuses.</p>
                    ...
                    <div class="tab-pane fade show active" id="html-sizes-spinner" role="tabpanel"
                        ...
                        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
                            <div class="d-flex flex-wrap align-items-center gap-5">
                                <div class="spinner-border text-primary w-48px h-48px" role="status">
                                    <span class="visually-hidden">Loading...</span>
                                </div>
                                <div class="spinner-grow text-primary w-48px h-48px" role="status">
                                    <span class="visually-hidden">Loading...</span>
                                </div>
                            </div>
