<?= $this->element('title_meta', ['title' => 'UI Form Selector']) ?>
...
<?= $this->element('page_title', ['title' => 'Forms', 'subTitle' => 'Form Selector']) ?>
        ...
        <div class="card card-h-100">
            ...
            <div class="card-body">
                <p class="text-muted">Custom <code>&lt;select&gt;</code> menus need only a custom class,
                    ...
                    <code>&lt;select&gt;</code>’s initial appearance and cannot modify the <code>&lt;option&gt;</code>s
...
<div class="row">
    ...
    <div class="col-12 col-xl-6">
        <div class="card card-h-100">
            <div class="card-header">
                <h5 class="card-title"> Option Groups </h5>
            </div>
            <div class="card-body">
    ...
    <div class="col-12 col-xl-6">
        <div class="card card-h-100">
            <div class="card-header">
                <h5 class="card-title"> Default Multiple Select </h5>
            </div>
            <div class="card-body">
    ...
    <div class="col-12 col-xl-6">
        <div class="card card-h-100">
            <div class="card-header">
                <h5 class="card-title"> Multiple Select With Close Icon </h5>
            </div>
            <div class="card-body">
    ...
    <div class="col-12 col-xl-6">
        <div class="card card-h-100">
            <div class="card-header">
                <h5 class="card-title"> Multiple Select With Limit </h5>
            </div>
            <div class="card-body">
    ...
    <div class="col-12 col-xl-6">
        <div class="card card-h-100">
            <div class="card-header">
                <h5 class="card-title"> Multiple Select With Option Groups </h5>
            </div>
            <div class="card-body">
    ...
    <div class="col-12 col-xl-6">
        <div class="card card-h-100">
            <div class="card-header">
                <h5 class="card-title"> Unique Values Only, No Pasting </h5>
            </div>
            <div class="card-body">
    ...
    <div class="col-12 col-xl-6">
        <div class="card card-h-100">
            <div class="card-header">
                <h5 class="card-title"> Email Address Only </h5>
            </div>
            <div class="card-body">
