...
<?= $this->element('page_title', ['title' => 'Base UI', 'subTitle' => 'Google Maps']) ?>
...
<div class="row">
    ...
    <div class="col-12 col-lg-6">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">Map With Marker</h5>
            </div>
            <div class="card-body">
    ...
    <div class="col-12 col-lg-6">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">Map With Overlays</h5>
            </div>
            <div class="card-body">
    ...
    <div class="col-12 col-lg-6">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">Map Type</h5>
            </div>
            <div class="card-body">
