<?= $this->element('title_meta', ['title' => 'Remix Icons']) ?>

<?= $this->element('page_title', ['title' => 'Base UI', 'subTitle' => 'Remix Icons']) ?>
        ...
        <div class="card">
            <div class="card-header">
                ...
                <p class="card-title-desc text-muted mb-0">
                    Easily incorporate icons into your project. Use
                    <code>&lt;i class="ri-ICONNAME"&gt;&lt;/i&gt;</code> to display any icon from the list
                    below.
                </p>
            </div>
            <div class="card-body">
                ...
                <div class="p-3 border border-primary-subtle bg-primary-subtle rounded mt-5">
                    <div class="row">
                        <div class="col">
                            ...
                            <p class="text-muted mb-0 text-sm">Open-source neutral-style system symbols
                                elaborately crafted for designers and developers.
                                All of the icons are free for both personal and commercial use.</p>
                        </div> <!--end col-->
                        <div class="col-auto align-self-center">
                            <a href="https://remixicon.com" target="_blank" type="button" class="btn btn-primary">View
                                All Icons</a>
                        </div> <!--end col-->
                    </div><!--end row-->
                </div>
