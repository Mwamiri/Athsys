<?= $this->element('title_meta', ['title' => 'UI Input Masks']) ?>

<?= $this->element('page_title', ['title' => 'Forms', 'subTitle' => 'Input Masks']) ?>

<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">Date Input Fields</h5>
            </div>
            <div class="card-body">
                <p class="text-muted">Use the fields below to enter a date. Please follow the specified format for each
                    field:</p>
                <div class="row g-5">
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">Time Input Fields</h5>
            </div>
            <div class="card-body">
                <p class="text-muted">Use the fields below to enter a time. Make sure to follow the specified format:
                </p>
                <div class="row g-5">
                    <div class="col-12 col-xl-6 col-xxl-4">
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">Custom Input Fields</h5>
            </div>
            <div class="card-body">
                ...
                <div class="row g-5">
                    ...
                    <div class="col-12 col-xl-6 col-xxl-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="formatted-contact" name="formatted-contact"
                                placeholder="(123) (456) (7890)">
                        </div>
                        <small class="text-muted">Example: (123) (456) (7890)</small>
                    </div>
                    ...
                    <div class="col-12 col-xl-6 col-xxl-4">
                        ...
                        <input type="text" class="form-control" id="prefix-delimiters" name="prefix-delimiters"
