<?= $this->element('title_meta', ['title' => 'Datatable Tables']) ?>
...
<?= $this->element('page_title', ['title' => 'Base UI', 'subTitle' => 'Datatable']) ?>
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="text-muted mb-4">Display tabular data with advanced features like sorting, pagination, and searching using <code>DataTables</code> for an enhanced user experience.</p>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <!--start::card-->
                            <div class="card-header">
                                <h5 class="card-title"> Vertical Scroll Datatable </h5>
                            </div>
                            <div class="card-body">
                                <p class="text-muted mb-4">Enable vertical scrolling in your datatable to display large datasets in a fixed-height container without pagination using <code>DataTables</code>.</p>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <!--start::card-->
                            <div class="card-header">
                                <h5 class="card-title"> Horizontal Scroll Datatable </h5>
                            </div>
                            <div class="card-body">
                                <p class="text-muted mb-4">Enable horizontal scrolling for wide tables with many columns using <code>DataTables</code> to maintain responsive layout and accessibility.</p>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <!--start::card-->
                            <div class="card-header">
                                <h5 class="card-title"> Alternative Pagination Datatable </h5>
                            </div>
                            <div class="card-body">
                                <p class="text-muted mb-4">Use alternative pagination styles with <code>DataTables</code> to enhance navigation and improve user experience across large datasets.</p>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <!--start::card-->
                            <div class="card-header">
                                <h5 class="card-title"> Buttons Datatables </h5>
                            </div>
                            <div class="card-body">
                               <p class="text-muted mb-4">A simple static table without sorting, searching, or pagination. Useful for displaying small data sets.</p>
