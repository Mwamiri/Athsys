<?= $this->element('title_meta', ['title' => 'UI Alerts']) ?>

<!-- prism css -->
<link rel="stylesheet" href="assets/libs/prismjs/themes/prism-coy.min.css">

<?= $this->element('page_title', ['title' => 'Base UI', 'subTitle' => 'Alerts']) ?>
...
<div class="row">
    <div class="col-xl-6">
        <div class="card card-h-100">
            ...
            <div class="card-body">
                <p class="text-muted">Alerts are available for any length of text, as well as an optional close button.
                    For proper styling, use one of the eight <strong>required</strong> contextual classes
...
&lt;/div&gt;</code></pre>
    ...
    <div class="col-xl-6">
        <div class="card card-h-100">
            <div class="card-header">
                <h5 class="card-title">Subtle Alerts</h5>
...
&lt;/div&gt;</code></pre>
    ...
    <div class="col-xl-6">
        <div class="card card-h-100">
            <div class="card-header">
                <h5 class="card-title">Left Border Alerts</h5>
            ...
            <div class="card-body">
                <p class="text-muted"> Add a <strong>left border</strong> to alerts in Bootstrap using the
                    <code>.alert-border-*</code> class. This class applies a primary color border to the left side of
                    the alert box.
                </p>
...
&lt;/div&gt;</code></pre>
    ...
    <div class="col-xl-6">
        <div class="card card-h-100">
            <div class="card-header">
                <h5 class="card-title">Subtle Alerts with Icons</h5>
                <ul class="nav nav-pills nav-preview nav-primary mb-0" id="subtle-alerts-icons" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="html-subtle-alerts-icons-tab" data-bs-toggle="pill"
                            data-bs-target="#html-subtle-alerts-icons" type="button" role="tab"
                            aria-controls="html-subtle-alerts-icons" aria-selected="true">HTML</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="preview-subtle-alerts-icons-tab" data-bs-toggle="pill"
                            data-bs-target="#preview-subtle-alerts-icons" type="button" role="tab"
                            aria-controls="preview-subtle-alerts-icons" aria-selected="false">Preview</button>
                    </li>
                </ul>
            </div>
            <div class="card-body">
                <p class="text-muted">Create <strong>outline alerts</strong> with Bootstrap using the
                    ...
                    classes. Replace <code>*</code> with a color variant like <code>primary</code>,
                    <code>success</code>, or
                    <code>danger</code> for different outline styles.
                </p>
                <div class="tab-content" id="subtle-alerts-iconsContent">
                    <div class="tab-pane fade show active" id="html-subtle-alerts-icons" role="tabpanel"
                        aria-labelledby="html-subtle-alerts-icons-tab" tabindex="0">
                        <div class="alert alert-subtle-primary alert-dismissible fade show rounded-pill d-flex align-items-center"
                            role="alert">
                            <i class="bi bi-info-circle-fill me-2"></i>
                            A simple primary alert—check it out!
                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                        </div>
                        <div class="alert alert-subtle-secondary alert-dismissible fade show rounded-pill d-flex align-items-center"
                            role="alert">
                            <i class="bi bi-exclamation-circle-fill me-2"></i>
                            A simple secondary alert—check it out!
                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                        </div>
                        <div class="alert alert-subtle-success alert-dismissible fade show rounded-pill d-flex align-items-center"
                            role="alert">
                            <i class="bi bi-check-circle-fill me-2"></i>
                            A simple success alert—check it out!
                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                        </div>
                        <div class="alert alert-subtle-danger alert-dismissible fade show rounded-pill d-flex align-items-center"
                            role="alert">
                    ...
                    <div class="tab-pane fade" id="preview-subtle-alerts-icons" role="tabpanel"
                        aria-labelledby="preview-subtle-alerts-icons-tab" tabindex="0">
...
&lt;/div&gt;</code></pre>
    ...
    <div class="col-xl-6">
        <div class="card card-h-100">
            <div class="card-header">
                <h5 class="card-title">Enhanced Alerts with Left Borders</h5>
                <ul class="nav nav-pills nav-preview nav-primary mb-0" id="bordered-alerts-tabs" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="bordered-alerts-html-tab" data-bs-toggle="pill"
                            data-bs-target="#bordered-alerts-html" type="button" role="tab"
                            aria-controls="bordered-alerts-html" aria-selected="true">HTML</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="bordered-alerts-preview-tab" data-bs-toggle="pill"
                            data-bs-target="#bordered-alerts-preview" type="button" role="tab"
                            aria-controls="bordered-alerts-preview" aria-selected="false">Preview</button>
                    </li>
                </ul>
            </div>
            <div class="card-body">
                ...
                <div class="tab-content" id="bordered-alerts-content">
                    <div class="tab-pane fade show active" id="bordered-alerts-html" role="tabpanel"
                        aria-labelledby="bordered-alerts-html-tab" tabindex="0">
                        <div class="alert alert-border-primary d-flex align-items-center alert-dismissible fade show"
                            role="alert">
                            <i class="bi bi-info-circle-fill me-2"></i>
                            <div>A simple primary alert—check it out!</div>
                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                        </div>
                        <div class="alert alert-border-secondary d-flex align-items-center alert-dismissible fade show"
                            role="alert">
                            <i class="bi bi-exclamation-circle-fill me-2"></i>
                            <div>A simple secondary alert—check it out!</div>
                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                        </div>
                        <div class="alert alert-border-success d-flex align-items-center alert-dismissible fade show"
                            role="alert">
                            <i class="bi bi-check-circle-fill me-2"></i>
                            <div>A simple success alert—check it out!</div>
                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                        </div>
                        <div class="alert alert-border-danger d-flex align-items-center alert-dismissible fade show"
                            role="alert">
                            <i class="bi bi-x-circle-fill me-2"></i>
                    ...
                    <div class="tab-pane fade" id="bordered-alerts-preview" role="tabpanel"
                        aria-labelledby="bordered-alerts-preview-tab" tabindex="0">
...
&lt;/div&gt;</code></pre>
    ...
    <div class="col-xl-6">
        <div class="card card-h-100">
            ...
            <div class="card-body">
                <p class="text-muted">Display <strong>default alerts</strong> in Bootstrap using the <code>.alert</code>
                    class. Add contextual classes like <code>.alert-primary</code>, <code>.alert-success</code>, or
                    <code>.alert-danger</code> for different alert styles.
                </p>
                ...
                <ul class="nav nav-pills nav-preview nav-primary mb-0" id="link-alerts" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="html-link-alerts-tab" data-bs-toggle="pill"
                            data-bs-target="#html-link-alerts" type="button" role="tab" aria-controls="html-link-alerts"
...
&lt;/div&gt;</code></pre>
    ...
    <div class="col-lg-12">
        <div class="card card-h-100">
            <div class="card-header">
                <h5 class="card-title">Icons Alerts</h5>
            ...
            <div class="card-body">
                <p class="text-muted">Similarly, you can use flexbox utilities and Bootstrap Icons to create alerts with
                    icons. Depending on your icons and content, you may want to add more utilities or custom styles.</p>
