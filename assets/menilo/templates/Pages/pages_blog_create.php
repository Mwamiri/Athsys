...
<?= $this->element('page_title', ['title' => 'Page', 'subTitle' => 'Blog Create']) ?>
        ...
        <form action="#" method="POST">
          <div class="row g-5">
            ...
            <div class="col-xl-4">
              ...
              <input type="text" class="form-control" id="PublishDate" placeholder="Select a date">
            </div>
            <div class="col-xl-4">
            ...
            <div class="col-xl-4">
              <label for="BlogStatus" class="form-label">Blog Visibility</label>
            ...
            <div class="col-12">
              ...
              <textarea name="forsummary" id="BlogExcerpt" rows="4" class="form-control"
                placeholder="Write short summary..."></textarea>
            </div>
            <div class="col-12">
            ...
            <div class="col-12">
              ...
              <div class="file-upload dropzone" id="blogImage"></div>
            </div>
