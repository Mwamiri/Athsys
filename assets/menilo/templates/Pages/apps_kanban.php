<?= $this->element('title_meta', ['title' => 'Kanban']) ?>
...
<?= $this->element('page_title', ['title' => 'Applications', 'subTitle' => 'Kanban']) ?>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <div>
                    <h4>Tasks</h4>
                    <p class="mb-0 text-muted">Keep track of your teams tasks all in one place.</p>
                </div>
                <div class="d-flex flex-wrap gap-3 align-items-center">
                    ...
                    <div class="avatar-group">
                        ...
                        <a href="javascript:void(0)" class="avatar-item fw-semibold avatar-title bg-primary">
                            <span class="d-flex align-items-center justify-content-center avatar-md">3+</span>
                        </a>
                    </div>
                ...
                <div class="d-flex overflow-x-scroll gap-4">
                    ...
                    <div class="kanban-list">
                        <div class="d-flex justify-content-between align-items-center pb-4 border-bottom">
                            <h5 class="mb-0">New Requested</h5>
                            <div class="d-flex align-items-center gap-3">
                                <button type="button" class="btn border-0 p-0"><i class="bi bi-plus fs-4"></i></button>
                        ...
                        <div id="b1">
                            <div class="card border my-4">
                                <div class="card-body p-4">
                                    <img src="assets/images/small/img-12.jpg" class="img-fluid rounded-2 mb-3"
                                        alt="Image">
                                    <span class="badge bg-danger-subtle text-danger"><i
                                            class="ri-circle-fill me-1"></i>Important</span>
                                    <span class="badge bg-info-subtle text-info">UI/UX Designer</span>
                                    <div class="dropdown dropdown-menu-end float-end">
                                        <a class="btn border-0 p-0" type="button" data-bs-toggle="dropdown"
                                            aria-expanded="false">
                                            <i class="bi bi-three-dots"></i>
                                        </a>
                                        <ul class="dropdown-menu">
                                    ...
                                    <div class="py-3">
                                        ...
                                        <p class="mb-0 fs-13 text-muted">Lorem ipsum dolor sit amet consectetur,
                                            adipisicing elit. Consequuntur placeat pariatur saepe.</p>
                                    </div>
                            ...
                            <div class="card border my-4">
                                ...
                                <div class="card-footer p-4 d-flex align-items-center justify-content-between">
                                    <div class="avatar-group">
                                        ...
                                        <a href="#!" class="avatar-item">
                                            <img class="img-fluid avatar-sm" src="assets/images/avatar/avatar-9.jpg"
                                                alt="avatar image">
                                        </a>
                                    </div>
                                    <div class="d-flex justify-content-end gap-2 align-content-center fs-12">
                    ...
                    <div class="kanban-list">
                        ...
                        <div id="b3">
                            ...
                            <div class="card border my-4">
                                <div class="card-body p-4">
                                    <img src="assets/images/small/img-5.jpg" class="img-fluid rounded-2 mb-3"
                                        alt="Image">
                            ...
                            <div class="card border my-4">
                                ...
                                <div class="card-footer p-4 d-flex align-items-center justify-content-between">
                                    <div class="avatar-group">
                                        ...
                                        <a href="#!" class="avatar-item">
                                            <img class="img-fluid avatar-sm" src="assets/images/avatar/avatar-10.jpg"
                                                alt="avatar image">
                                        </a>
                                    </div>
                                    <div class="d-flex justify-content-end gap-2 align-content-center fs-12">
                    ...
                    <div class="kanban-list">
                        ...
                        <div id="b4">
                            <div class="card border my-4">
                                <div class="card-body p-4">
                                    <img src="assets/images/small/img-13.jpg" class="img-fluid rounded-2 mb-3"
                                        alt="Image">
                                    <span class="badge bg-info-subtle text-info">High</span>
                                    <span class="badge bg-danger-subtle text-danger">Important</span>
                                    <div class="dropdown dropdown-menu-end float-end">
                                ...
                                <div class="card-footer p-4 d-flex align-items-center justify-content-between">
                                    <div class="avatar-group">
                                        ...
                                        <a href="#!" class="avatar-item">
                                            <img class="img-fluid avatar-sm" src="assets/images/avatar/avatar-11.jpg"
                                                alt="avatar image">
                                        </a>
                                    </div>
                                    <div class="d-flex justify-content-end gap-2 align-content-center fs-12">
                            ...
                            <div class="card border my-4">
                                ...
                                <div class="card-footer p-4 d-flex align-items-center justify-content-between">
                                    <div class="avatar-group">
                                        ...
                                        <a href="#!" class="avatar-item">
                                            <img class="img-fluid avatar-sm" src="assets/images/avatar/avatar-12.jpg"
                                                alt="avatar image">
                                        </a>
                                    </div>
                                    <div class="d-flex justify-content-end gap-2 align-content-center fs-12">
                    ...
                    <!-- Closed Lost -->
                    <div class="kanban-list" id="5">
                        <div class="mb-4">
                            <button type="button" class="btn btn-light w-100">+ Add Card</button>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-12">
                            <div class="d-flex flex-column align-items-center justify-content-center p-3 rounded">
                                <div class="position-relative">
                                    <img id="avatarPreview" src="assets/images/avatar/15.jpg" alt="Avatar Preview"
