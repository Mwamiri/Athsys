<?= $this->element('title_meta', ['title' => 'UI Form Layout']) ?>
...
<?= $this->element('page_title', ['title' => 'Forms', 'subTitle' => 'Layout']) ?>
...
<div class="row">
    <div class="col-12 col-xl-6">
        <div class="card card-h-100">
            ...
            <div class="card-body">
                <p class="text-muted mb-4">Fill out the form below with your personal and contact information to proceed.</p>
                ...
                <div class="col-12 col-xl-6">
                    <div class="card card-h-100">
                        ...
                        <div class="card-body">
                            <p class="text-muted mb-4">Please complete all fields below. All inputs are required to proceed with the form submission.</p>
                            <form action="javascript:void(0);">
                                <div class="row g-4">
                                    <div class="col-xxl-6">
                ...
                <div class="col-12 col-xl-6">
                    <div class="card card-h-100">
                        <div class="card-header">
                            <h5 class="card-title">Vertical Form With Label</h5>
                        </div>
                        <div class="card-body">
                            <p class="text-muted mb-4">Fill in the form below with accurate details. All fields are required for submission.</p>
                            <form action="javascript:void(0);">
                                <div class="row g-4">
                                    <div class="col-xxl-6">
                ...
                <div class="col-12 col-xl-6">
                    <div class="card card-h-100">
                        <div class="card-header">
                            <h5 class="card-title">Vertical Form With Icon</h5>
                        </div>
                        <div class="card-body">
                            <p class="text-muted mb-4">Please complete the form below. All fields are required and icons indicate input types for better guidance.</p>
                            <form action="javascript:void(0);">
                                <div class="row g-4">
                                    <div class="col-xxl-6">
                ...
                <div class="col-12 col-xl-6">
                    <div class="card card-h-100">
                        <div class="card-header">
                            <h5 class="card-title">Horizontal Form With Label</h5>
                        </div>
                        <div class="card-body">
                            <p class="text-muted mb-4">Fill out the form below using horizontal label alignment for better clarity and space efficiency.</p>
                            <form action="javascript:void(0);">
                                <div class="row mb-3">
                ...
                <div class="col-12 col-xl-6">
                    <div class="card card-h-100">
                        <div class="card-header">
                            <h5 class="card-title">Horizontal Form With Icon</h5>
                        </div>
                        <div class="card-body">
                            <p class="text-muted mb-4">This form layout uses icons and horizontal alignment to enhance user experience and visual appeal.</p>
                            <form action="javascript:void(0);">
                                <div class="row mb-3">
                                    <div class="col-lg-3 d-flex align-items-center">
                ...
                <div class="col-12 col-xl-6">
                    <div class="card card-h-100">
                        ...
                        <div class="card-body">
                            <p class="text-muted mb-4">Demonstrates different input sizes (small, default, and large) in a horizontal form layout using Bootstrap classes.</p>
                            <form action="javascript:void(0);">
                                <div class="row mb-3">
                                    <div class="col-lg-3 d-flex align-items-center">
                ...
                <div class="col-12 col-xl-6">
                    <div class="card card-h-100">
                        ...
                        <div class="card-body">
                            <p class="text-muted mb-4">Use Bootstrap's grid system to control the width of inputs responsively using column sizing utilities.</p>
                            <form action="javascript:void(0);">
                                <div class="row g-3">
                                    <div class="col-12">
                ...
                <div class="col-12">
                    <div class="card card-h-100">
                        ...
                        <div class="card-body">
                            <p class="text-muted mb-4">Easily align form controls side-by-side using Bootstrap’s inline form layout with responsive grid classes.</p>
