<?= $this->element('title_meta', ['title' => 'Advanced UI Media Player']) ?>

<!-- plyr css -->
<link rel="stylesheet" href="assets/libs/plyr/plyr.css">

<?= $this->element('page_title', ['title' => 'Advanced UI', 'subTitle' => 'Media Player']) ?>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">YouTube Video Player</h5>
            </div>
            <div class="card-body">
                <p class="text-muted mb-2">Enter a YouTube URL below to watch the video.</p>
                <p class="text-muted mb-4">Embed a YouTube video with custom controls using <code>Plyr.io</code>. Simply
                    include a YouTube <code>&lt;iframe&gt;</code> and initialize <code>Plyr</code> for a sleek,
                    customizable video player experience.</p>
