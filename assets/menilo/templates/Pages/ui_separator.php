<?= $this->element('title_meta', ['title' => 'UI Separator']) ?>

<!-- prism css -->
<link rel="stylesheet" href="assets/libs/prismjs/themes/prism-coy.min.css" />

<?= $this->element('page_title', ['title' => 'Base UI', 'subTitle' => 'Separator']) ?>
...
<div class="row">
    ...
    <div class="col-12 col-xl-6">
        <div class="card card-h-100">
            <div class="card-header">
                <h5 class="card-title">Basic Horizontal Row</h5>
            ...
            <div class="card-body">
                <div class="tab-content" id="basic-horizontal-rowContent">
                    <div class="tab-pane fade show active" id="html-basic-horizontal-row" role="tabpanel"
                        ...
                        <div>
                            <p>Welcome to Menilo! Here, you'll find a wealth of information and resources designed to
    ...
    &lt;p&gt;Welcome to Menilo! Here, you'll find a wealth of information and resources designed to enhance your experience.&lt;/p&gt;
    &lt;hr&gt;
    &lt;p&gt;Explore our latest updates and discover exciting opportunities that await you.&lt;/p&gt;
&lt;/div&gt;</code></pre>
                    </div>
    ...
    <div class="col-12 col-xl-6">
        <div class="card card-h-100">
            <div class="card-header">
                <h5 class="card-title">Horizontal Row Styles</h5>
...
&lt;hr class=&quot;mt-5 border-primary border-dashed&quot;&gt;</code></pre>
    ...
    <div class="col-12 col-xl-6">
        <div class="card card-h-100">
            <div class="card-header">
                <h5 class="card-title">Horizontal Row Colors</h5>
                <ul class="nav nav-pills nav-preview nav-primary mb-0" id="colors-horizontal-row" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="preview-colors-horizontal-row-tab" data-bs-toggle="pill"
                            ...
                            aria-controls="preview-colors-horizontal-row   " aria-selected="false">Preview</button>
                    </li>
                </ul>
            </div>
            <div class="card-body">
...
&lt;hr class=&quot;mt-5 border-dark&quot;&gt;</code></pre>
    ...
    <div class="col-12 col-xl-6">
        <div class="card card-h-100">
            <div class="card-header">
                <h5 class="card-title">Horizontal Row Sizes</h5>
...
&lt;hr class=&quot;mt-5 border-5&quot;&gt;</code></pre>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">Horizontal Row Content</h5>
                <ul class="nav nav-pills nav-preview nav-primary mb-0" id="content-horizontal-row" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="html-content-horizontal-row-tab" data-bs-toggle="pill"
                            data-bs-target="#html-content-horizontal-row" type="button" role="tab"
                            aria-controls="html-content-horizontal-row" aria-selected="true">HTML</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="preview-content-horizontal-row-tab" data-bs-toggle="pill"
                            ...
                            aria-controls="preview-content-horizontal-row   " aria-selected="false">Preview</button>
                    </li>
                </ul>
            </div>
            <div class="card-body">
                <div class="tab-content" id="content-horizontal-rowContent">
                    <div class="tab-pane fade show active" id="html-content-horizontal-row" role="tabpanel"
                        ...
                        <div class="center-hr my-5">Menilo</div>
                        <div class="center-hr mb-5 hr-secondary"><span class="h1 m-0">Menilo</span></div>
                        <div class="center-hr mb-5 hr-primary border-dashed"><span class="min-w-256px fw-bold">Long
                                separator title label</span></div>
                    </div>
                    <div class="tab-pane fade" id="preview-content-horizontal-row" role="tabpanel"
                        ...
                        <pre
                            class="language-html"><code>&lt;div class=&quot;center-hr my-5&quot;&gt;Menilo&lt;/div&gt;
&lt;div class=&quot;center-hr mb-5 hr-secondary&quot;&gt;&lt;span class=&quot;h1 m-0&quot;&gt;Menilo&lt;/span&gt;&lt;/div&gt;
&lt;div class=&quot;center-hr mb-5 hr-primary border-dashed&quot;&gt;&lt;span class=&quot;min-w-256px fw-bold&quot;&gt;Long separator title label&lt;/span&gt;&lt;/div&gt;</code></pre>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">Basic Vertical Row</h5>
