...
<?= $this->element('page_title', ['title' => 'Applications', 'subTitle' => 'Chat']) ?>
            ...
            <div class="p-6">
                <div class="mb-4 pb-6 border-bottom">
                    <div class="d-flex align-items-center justify-content-between position-relative">
                        ...
                        <div class="d-xl-none me-n10" data-bs-toggle="tooltip" data-bs-trigger="hover"
                            data-bs-placement="bottom" aria-label="Close Button" data-bs-original-title="Close Button"
                            aria-describedby="tooltip430017">
                            <a href="javascript:void(0)" class="bg-light text-success p-2 rounded-pill"
                                id="close-chat-sidebar" aria-label="Close chat sidebar">
                ...
                <div class="text-center my-4">
                    <div class="form-icon right d-none d-md-block" data-bs-toggle="modal" data-bs-target="#searchChat">
                        <input type="text" class="form-control form-control-icon bg-transparent w-100" id="SearchChat"
                        ...
                        <ul id="chatList" class="list-unstyled mb-0">
                            <li id="chat1" class="d-flex align-items-center gap-3 px-4 py-3 my-2">
                                <div class="avatar-wrapper active flex-shrink-0 position-relative">
                                    <img src="assets/images/avatar/avatar-1.jpg" class="avatar-lg rounded-circle"
                            ...
                            <li id="chat2" class="d-flex align-items-center gap-3 px-4 py-3 mb-2">
                                <div class="avatar-wrapper active flex-shrink-0 position-relative">
                                    <img src="assets/images/avatar/avatar-12.jpg" class="avatar-lg rounded-circle"
                                        height="36" alt="avatar">
                                </div>
                                <div class="flex-grow-1 overflow-hidden">
                                    <h6 class="my-0">
                            ...
                            <li class="d-flex align-items-center gap-3 px-4 py-3 mb-2 active">
                                <div class="avatar-wrapper active flex-shrink-0 position-relative">
                                    <img src="assets/images/avatar/avatar-2.jpg" class="avatar-lg rounded-circle"
                                        height="36" alt="avatar">
                                </div>
                                <div class="flex-grow-1 overflow-hidden">
                                    <h6 class="my-0">
                            ...
                            <li id="chat3" class="d-flex align-items-center gap-3 px-4 py-3 mb-2">
                                <div class="avatar-wrapper active flex-shrink-0 position-relative">
                                    <img src="assets/images/avatar/avatar-3.jpg" class="avatar-lg rounded-circle"
                                        height="36" alt="avatar">
                                </div>
                                <div class="flex-grow-1 overflow-hidden">
                                    <h6 class="my-0">
                            ...
                            <li id="chat4" class="d-flex align-items-center gap-3 px-4 py-3 mb-2">
                                <div class="avatar-wrapper flex-shrink-0 position-relative">
                                    <img src="assets/images/avatar/avatar-4.jpg" class="avatar-lg rounded-circle"
                                        height="36" alt="avatar">
                                </div>
                                <div class="flex-grow-1 overflow-hidden">
                                    <h6 class="my-0">
                            ...
                            <li id="chat5" class="d-flex align-items-center gap-3 px-4 py-3 mb-2">
                                <div class="avatar-wrapper active flex-shrink-0 position-relative">
                                    <img src="assets/images/avatar/avatar-5.jpg" class="avatar-lg rounded-circle"
                                        height="36" alt="avatar">
                                </div>
                                <div class="flex-grow-1 overflow-hidden">
                                    <h6 class="my-0">
                            ...
                            <li id="chat6" class="d-flex align-items-center gap-3 px-4 py-3 mb-2">
                                <div class="avatar-wrapper flex-shrink-0 position-relative">
                                    <img src="assets/images/avatar/avatar-6.jpg" class="avatar-lg rounded-circle"
                                        height="36" alt="avatar">
                                </div>
                                <div class="flex-grow-1 overflow-hidden">
                                    <h6 class="my-0">
                            ...
                            <li id="chat7" class="d-flex align-items-center gap-3 px-4 py-3 mb-2">
                                <div class="avatar-wrapper active flex-shrink-0 position-relative">
                                    <img src="assets/images/avatar/avatar-7.jpg" class="avatar-lg rounded-circle"
                                        height="36" alt="avatar">
                                </div>
                                <div class="flex-grow-1 overflow-hidden">
                                    <h6 class="my-0">
                            ...
                            <li id="chat8" class="d-flex align-items-center gap-3 px-4 py-3 mb-2">
                                <div class="avatar-wrapper active flex-shrink-0 position-relative">
                                    <img src="assets/images/avatar/avatar-8.jpg" class="avatar-lg rounded-circle"
                                        height="36" alt="avatar">
                                </div>
                                <div class="flex-grow-1 overflow-hidden">
                                    <h6 class="my-0">
                            ...
                            <li id="chat9" class="d-flex align-items-center gap-3 px-4 py-3 mb-2">
                                <div class="avatar-wrapper flex-shrink-0 position-relative">
                                    <img src="assets/images/avatar/avatar-9.jpg" class="avatar-lg rounded-circle"
                                        height="36" alt="avatar">
                                </div>
                                <div class="flex-grow-1 overflow-hidden">
                                    <h6 class="my-0">
                    ...
                    <div class="col-sm-4 col-8">
                        <div class="d-flex align-items-center">
                            <div class="flex-shrink-0 d-block d-xl-none me-4">
                                <a href="#!" class="btn btn-light icon-btn fs-5" id="open-chat-sidebar"
                                ...
                                <a href="#!" id="selectedUserProfile">
                                    <div id="selectedUserAvatarWrapper" class="avatar-wrapper active flex-shrink-0">
                                        <img id="selectedUserAvatar" src="assets/images/avatar/avatar-12.jpg"
                                            class="h-30px w-30px rounded-circle" alt="avatar image">
                                        <span class="user-status"></span>
                                    </div>
                                    <div>
                                        <div class="offcanvas offcanvas-end position-absolute" data-simplebar
                                            tabindex="-1" id="userProfile" aria-labelledby="userProfileLabel">
                                            ...
                                            <div class="d-flex justify-content-center position-relative">
                                                <div class="position-relative">
                                                    <img src="assets/images/avatar/avatar-12.jpg" alt="Avatar Image"
                                                        class="h-100px w-100px img-thumbnail rounded-pill">
                                                    <div class="position-absolute bottom-0 end-0">
                                                        <i
                                                            class="bi bi-patch-check-fill fs-16 ms-n5 mt-n5 text-success"></i>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="text-center my-4">
                                                ...
                                                <div class="d-flex gap-2 justify-content-center">
                                                    <button type="button" class="btn btn-sm bg-light"
                                                        ...
                                                        aria-label="Message" data-bs-original-title="Message"
                                                        aria-describedby="tooltip324973">
                                                        <i class="ri-question-answer-line"></i>
                                                    </button>
                                                    <button type="button" class="btn btn-sm bg-light"
                                                        data-bs-toggle="tooltip" data-bs-placement="top"
                                                        aria-label="Favourite" data-bs-original-title="Favourite">
                                                        <i class="ri-star-line"></i>
                                                    </button>
                                                    <button type="button" class="btn btn-sm bg-light"
                                                        data-bs-toggle="tooltip" data-bs-placement="top"
                                                        aria-label="Phone" data-bs-original-title="Phone">
                                                        <i class="ri-phone-line"></i>
                                                    </button>
                                                    <div class="dropdown">
                                                        <button class="btn btn-sm bg-light" type="button"
                                            ...
                                            <div class="border-top p-4">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="row g-2">
                                                        <div class="col-auto">
                                                            <img class="rounded-2 avatar-lg"
                                                                src="assets/images/small/img-1.jpg" alt="chat-img" />
                                                        </div>
                                                        <div class="col-auto">
                                                            <img class="rounded-2 avatar-lg"
                                                                src="assets/images/small/img-2.jpg" alt="chat-img" />
                                                        </div>
                                                        <div class="col-auto">
                                                            <img class="rounded-2 avatar-lg"
                                                                src="assets/images/small/img-3.jpg" alt="chat-img" />
                                                        </div>
                                                        <div class="col-auto">
                                                            <img class="rounded-2 avatar-lg"
                                                                src="assets/images/small/img-4.jpg" alt="chat-img" />
                                                        </div>
                                                        <div class="col-auto">
                                                            <img class="rounded-2 avatar-lg"
                                                                src="assets/images/small/img-5.jpg" alt="chat-img" />
                                                        </div>
                                                        <div class="col-auto">
                                                            <img class="rounded-2 avatar-lg"
                                                                src="assets/images/small/img-6.jpg" alt="chat-img" />
                                                        </div>
                                                        <div class="col-auto">
                                                            <img class="rounded-2 avatar-lg"
                                                                src="assets/images/small/img-7.jpg" alt="chat-img" />
                                                        </div>
                                                        <div class="col-auto">
                                                            <img class="rounded-2 avatar-lg"
                                                                src="assets/images/small/img-8.jpg" alt="chat-img" />
                                                        </div>
                                                        <div class="col-auto">
                                                            <img class="rounded-2 avatar-lg"
                                                                src="assets/images/small/img-9.jpg" alt="chat-img" />
                                                        </div>
                                                        <div class="col-auto">
                                                            <img class="rounded-2 avatar-lg"
                                                                src="assets/images/small/img-10.jpg" alt="chat-img" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div>
                                                <h6 class="border-bottom pb-3 px-4 mb-0"><i
                                                        class="ri-folder-5-line me-2"></i> Attached Files</h6>
                                                <div
                                                    class="border-bottom d-flex align-items-center justify-content-between px-4">
                                                    <a class="d-flex align-items-center py-3" href="#!">
                                                        <div
                                                            class="d-flex justify-content-center align-items-center avatar-md border rounded-1 me-2">
                                                ...
                                                <a class="btn btn-link px-4" href="#!">See 3 more
                                                    <i class="ri-arrow-down-s-line ms-1"></i>
                                                </a>
                                            </div>
                                        </div>
                                        <h5 id="selectedUserName" class="text-truncate mb-0 fs-14">
                                            <a id="selectedUserLink" class="text-reset" data-bs-toggle="offcanvas"
                                                data-bs-target="#userProfile" href="#userProfileCanvasExample"
                                                aria-controls="userProfile">Sophia Turner</a>
                                        </h5>
                                        <p id="selectedUserStatus"
                                            class="text-truncate text-muted fs-10 mb-0 userStatus">Online</p>
                                    </div>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="d-flex gap-2 justify-content-end">
                            ...
                            <div class="dropdown">
                                <a href="javascript:void(0)" class="btn btn-light btn-sm" data-bs-toggle="dropdown"
                                    aria-expanded="true" aria-label="More options">
                                    <i class="bi bi-three-dots-vertical"></i>
                                </a>
                                <div class="dropdown-menu dropdown-menu-end">
                            ...
                            <div class="chat-input-links ms-2">
                                <div class="d-flex gap-4 align-items-center">
                                    <a href="#!" class="link text-body fs-4" data-bs-toggle="tooltip"
                                        data-bs-html="true" aria-label="Attach a Link"
                                        data-bs-original-title="Attach a Link">
                                        <i class="ri-link-m"></i>
                                    </a>
                                    <div class="file-upload">
                                        <a href="#!" class="link text-body fs-4" data-bs-toggle="tooltip"
                                            data-bs-html="true" title="Add a File">
                        ...
                        <div class="col-auto">
                            <div class="ms-2">
                                <div class="links-list-item">
                                    <button type="submit" class="btn btn-light" aria-label="Send"><i
