<?= $this->element('title_meta', ['title' => 'UI Modal']) ?>

<!-- prism css -->
<link rel="stylesheet" href="assets/libs/prismjs/themes/prism-coy.min.css">

<?= $this->element('page_title', ['title' => 'Base UI', 'subTitle' => 'Modal']) ?>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">Modal View</h5>
                <ul class="nav nav-pills nav-preview nav-primary mb-0" id="modal-view" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="html-modal-view-tab" data-bs-toggle="pill"
                            data-bs-target="#html-modal-view" type="button" role="tab" aria-controls="html-modal-view"
            ...
            <div class="card-body">
                <p class="text-muted">Below is a static modal example (meaning its <code>position</code> and
                    ...
                    <code>padding</code>), and modal footer (optional). We ask that you include modal headers with
                    dismiss actions whenever possible, or provide another explicit dismiss action.</p>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <p class="mb-4">We're thrilled to share the latest features designed to enhance
                                            your experience:</p>
                                        <ul class="list-group">
                                            ...
                                            <li class="list-group-item border-0 py-1">
                                                <i class="ri-bar-chart-line me-2 text-success"></i>Improved Analytics
                                                Dashboard
                                            </li>
                                            <li class="list-group-item border-0 py-1">
                                                <i class="ri-user-line me-2 text-warning"></i>User-Friendly Interface
                                                Updates
                                            </li>
                                        </ul>
...
&lt;/div&gt;</code></pre>
    ...
    <div class="col-12 col-xl-6">
        <div class="card">
            ...
            <div class="card-body">
                <p class="text-muted">Toggle a working modal demo by clicking the button below. It will slide down and
                    fade in from the top of the page.</p>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <p class="mb-4">We're excited to invite you to our upcoming webinar, where
                                            you'll learn:</p>
                                        <ul class="mt-3 list-group">
                                            <li class="list-group-item border-0">
                                                <i class="ri-bar-chart-line me-2 text-primary"></i>Tips and tricks for
                                            ...
                                            <li class="list-group-item border-0">
                                                <i class="ri-search-line me-2 text-warning"></i>Insights into the latest
                                                trends and technologies
                                            </li>
                                        </ul>
                                        <hr class="my-4">
                                        <div class="text-center">
                                            <p class="fw-bold mb-1">📅 <span class="text-primary">Date:</span> September
                                                30, 2024</p>
                                            <p class="fw-bold mb-1">🕒 <span class="text-primary">Time:</span> 3:00 PM -
                                                4:00 PM (EST)</p>
...
&lt;/div&gt;&lt;!--End modal--&gt;</code></pre>
    ...
    <div class="col-12 col-xl-6">
        <div class="card">
            ...
            <div class="card-body">
                <p class="text-muted">When backdrop is set to static, the modal will not close when clicking outside of
...
&lt;/div&gt;&lt;!--End modal--&gt;</code></pre>
    ...
    <div class="col-12 col-xl-6">
        <div class="card">
            ...
            <div class="card-body">
                <p class="text-muted">You can also create a scrollable modal that allows scrolling the modal body by
        ...
        <div class="card">
            <div class="card-header">
                ...
                <ul class="nav nav-pills nav-preview nav-primary mb-0" id="modal-vertically-centered" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="html-modal-vertically-centered-tab" data-bs-toggle="pill"
                            data-bs-target="#html-modal-vertically-centered" type="button" role="tab"
                            aria-controls="html-modal-vertically-centered" aria-selected="true">HTML</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="preview-modal-vertically-centered-tab" data-bs-toggle="pill"
                            ...
                            aria-controls="preview-modal-vertically-centered" aria-selected="false">Preview</button>
                    </li>
                </ul>
            </div>
            <div class="card-body">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <p class="text-muted"><a href="https://getbootstrap.com/docs/5.3/components/tooltips"
                        target="_blank">Tooltips</a> and <a href="https://getbootstrap.com/docs/5.3/components/popovers"
                        target="_blank">popovers</a> can be placed within modals as needed. When modals are closed, any
        ...
        <div class="card">
            ...
            <div class="card-body">
                <p class="text-muted">Toggle between multiple modals with some clever placement of the
                    ...
                    toggle a password reset modal from within an already open sign in modal. Please note multiple modals
                    cannot be open at the same time—this method simply toggles between two separate modals.</p>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <p class="text-muted mb-1">Have a bunch of buttons that all trigger the same modal with slightly
                    different contents? Use <code>event.relatedTarget</code> and HTML data-bs-* attributes to vary the
                    contents of the modal depending on which button was clicked.</p>
...
&lt;/div&gt;&lt;!--End modal--&gt;</code></pre>
    ...
    <div clas>
        <div class="card card-h-100">
            <div class="card-header">
                <h5 class="card-title">Modal Size</h5>
                <ul class="nav nav-pills nav-preview nav-primary mb-0" id="modal-size" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="html-modal-size-tab" data-bs-toggle="pill"
                            data-bs-target="#html-modal-size" type="button" role="tab" aria-controls="html-modal-size"
                            aria-selected="true">HTML</button>
                    </li>
                    <li class="nav-item" role="presentation">
            ...
            <div class="card-body">
                <p class="text-muted">Adjust the size of a Bootstrap modal by adding size-specific classes like
                    <code>.modal-sm</code> for small, <code>.modal-lg</code> for large, or <code>.modal-xl</code> for
                    extra-large to the <code>&lt;div class="modal-dialog"&gt;</code>.</p>
                <div class="tab-content" id="modal-sizeContent">
                    <div class="tab-pane fade show active d-flex flex-wrap gap-1" id="html-modal-size" role="tabpanel"
                        aria-labelledby="html-modal-size-tab" tabindex="0">
...
&lt;/div&gt;&lt;!-- end:: Small Modal Size --&gt;</code></pre>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">Fullscreen Modals Example</h5>
            ...
            <div class="card-body">
                <p class="text-muted">Handle long content in a Bootstrap modal by adding
                    <code>.modal-dialog-scrollable</code> to the <code>&lt;div class="modal-dialog"&gt;</code>. This
                    allows the modal body to scroll while keeping the header and footer fixed.</p>
                ...
                <div class="tab-content" id="modal-fullscreenContent">
                    <div class="tab-pane fade show active" id="html-modal-fullscreen" role="tabpanel"
                        ...
                        <!-- Scrollable  Modal Button -->
                        <div class="d-flex align-items-center gap-3 flex-wrap pt-5">
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                        ...
                        <div class="modal fade" id="exampleModalFullscreenSm" tabindex="-1"
                            ...
                            <div class="modal-dialog modal-fullscreen-sm-down">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalFullscreenSmLabel">Fullscreen below sm
                                        </h5>
                                        <button type="button" class="btn-close icon-btn-sm" data-bs-dismiss="modal"
                                            aria-label="Close">
                                            <i class="ri-close-large-line fw-semibold"></i>
                        ...
                        <div class="modal fade" id="exampleModalFullscreenMd" tabindex="-1"
                            ...
                            <div class="modal-dialog modal-fullscreen-md-down">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalFullscreenMdLabel">Fullscreen below md
                                        </h5>
                                        <button type="button" class="btn-close icon-btn-sm" data-bs-dismiss="modal"
                                            aria-label="Close">
                                            <i class="ri-close-large-line fw-semibold"></i>
                        ...
                        <div class="modal fade" id="exampleModalFullscreenLg" tabindex="-1"
                            ...
                            <div class="modal-dialog modal-fullscreen-lg-down">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalFullscreenLgLabel">Fullscreen below lg
                                        </h5>
                                        <button type="button" class="btn-close icon-btn-sm" data-bs-dismiss="modal"
                                            aria-label="Close">
                                            <i class="ri-close-large-line fw-semibold"></i>
                        ...
                        <div class="modal fade" id="exampleModalFullscreenXl" tabindex="-1"
                            ...
                            <div class="modal-dialog modal-fullscreen-xl-down">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalFullscreenXlLabel">Fullscreen below xl
                                        </h5>
                                        <button type="button" class="btn-close icon-btn-sm" data-bs-dismiss="modal"
                                            aria-label="Close">
                                            <i class="ri-close-large-line fw-semibold"></i>
                        ...
                        <div class="modal fade" id="exampleModalFullscreenXxl" tabindex="-1"
                            ...
                            <div class="modal-dialog modal-fullscreen-xxl-down">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalFullscreenXxlLabel">Fullscreen below xxl
                                        </h5>
                                        <button type="button" class="btn-close icon-btn-sm" data-bs-dismiss="modal"
                                            aria-label="Close">
                                            <i class="ri-close-large-line fw-semibold"></i>
...
&lt;/div&gt;</code></pre>
    ...
    <div class="col-12 col-xl-6">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">Draggable Modal</h5>
            ...
            <div class="card-body">
                <p class="text-muted">Make a Bootstrap modal draggable by adding the <code>data-draggable="true"</code>
                    attribute to the <code>&lt;div class="modal"&gt;</code> element. This allows users to move the modal
                    around the screen.</p>
                <div class="tab-content" id="modal-draggableContent">
                    <div class="tab-pane fade show active" id="html-modal-draggable" role="tabpanel"
                        ...
                        <div class="modal fade" id="dragModal" data-draggable="true" data-bs-keyboard="false"
                            tabindex="-1" aria-labelledby="dragModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
...
&lt;/div&gt;&lt;!--End modal--&gt;</code></pre>
    ...
    <div class="col-12 col-xl-6">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">Animated Modal</h5>
            </div>
            <div class="card-body">
                <p class="text-muted">Choose an animation from the dropdown and click <strong>Show Modal</strong> to see
                    the Bootstrap modal open with a smooth animation effect.</p>
                ...
                <div class="modal" id="anime1" data-bs-keyboard="false" tabindex="-1" aria-labelledby="anime1Label"
                    aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
