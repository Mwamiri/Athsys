<?= $this->element('title_meta', ['title' => 'UI Tooltip']) ?>

<!-- prism -->
<link rel="stylesheet" href="assets/libs/prismjs/themes/prism-coy.min.css" />

<?= $this->element('page_title', ['title' => 'Base UI', 'subTitle' => 'Tooltip']) ?>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">Tooltip Directions</h5>
            ...
            <div class="card-body">
                <p class="text-muted">Tooltip example are available with following options, Directions are mirrored when
...
&lt;/button&gt;</code></pre>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">Tooltip with HTML</h5>
            ...
            <div class="card-body">
                <p class="text-muted">When you hover over the button labeled "Tooltip with HTML," a tooltip will appear
                    displaying formatted text. The tooltip's content includes HTML elements such as
...
&lt;/button&gt;</code></pre>
    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">Custom Tooltips</h5>
            ...
            <div class="card-body">
                <p class="text-muted">You can customize the appearance of tooltips using CSS variables. We set a custom
                    class with <code>data-bs-custom-class="custom-tooltip"</code> to scope our custom appearance and use
                    it to override a local CSS variable.</p>
        ...
        <div class="card">
            <div class="card-header">
                ...
                <ul class="nav nav-pills nav-preview nav-primary mb-0" id="disabled-elements-tooltip" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="html-disabled-elements-tooltip-tab" data-bs-toggle="pill"
                            data-bs-target="#html-disabled-elements-tooltip" type="button" role="tab"
                            aria-controls="html-disabled-elements-tooltip" aria-selected="true">HTML</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="preview-disabled-elements-tooltip-tab" data-bs-toggle="pill"
                            ...
                            aria-controls="preview-disabled-elements-tooltip   " aria-selected="false">Preview</button>
                    </li>
                </ul>
            </div>
            <div class="card-body">
                <p class="text-muted">Elements with the <code>disabled</code> attribute aren’t interactive, meaning
                    users cannot focus, hover, or click them to trigger a tooltip (or popover). As a workaround, you’ll
                    want to trigger the tooltip from a wrapper <code>&lt;div&gt;</code> or <code>&lt;span&gt;</code>,
                ...
                <div class="tab-content" id="disabled-elements-tooltipContent">
                    <div class="tab-pane fade show active" id="html-disabled-elements-tooltip" role="tabpanel"
                        ...
                        <span class="d-inline-block" tabindex="0" data-bs-toggle="tooltip"
                            ...
                            <button type="button" class="btn btn-primary" type="button" disabled>Disabled
                                button</button>
                        </span>
                    </div>
...
&lt;/p&gt;</code></pre>
    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-header">
                <h5 class="card-title">Colored Tooltips</h5>
