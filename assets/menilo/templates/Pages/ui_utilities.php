<?= $this->element('title_meta', ['title' => 'UI Utilities']) ?>

<?= $this->element('page_title', ['title' => 'Base UI', 'subTitle' => 'Utilities']) ?>
...
<div class="row">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div>
                    ...
                    <p class="text-muted">Apply borders in Bootstrap using classes like <code>.border</code> for a full
                        border, <code>.border-top</code> for a top border, <code>.border-bottom</code> for a bottom
                        border, and similar classes for left and right. These classes help enhance the layout and
                        separation of elements.</p>
                ...
                <div class="mt-4">
                    ...
                    <p class="text-muted">Control border thickness in Bootstrap using classes like <code>.border</code>
                        for a default border and <code>.border-2</code> for a thicker border. You can also use
                        <code>.border-0</code> to remove borders entirely. These classes help you adjust the visual
                        weight of elements easily.
                    </p>
                ...
                <div class="mt-4">
                    ...
                    <p class="text-muted">Customize border styles in Bootstrap using classes like <code>.border</code>
                        for a solid border, <code>.border-dashed</code> for a dashed border, and
                        <code>.border-dotted</code> for a dotted border. These styles help add visual interest to your
                        components.
                    </p>
                    <div class="d-flex align-items-start flex-wrap gap-4 text-center">
                        <div
                ...
                <div class="mt-4">
                    ...
                    <p class="text-muted">Change border colors in Bootstrap using classes like
                        <code>.border-primary</code>, <code>.border-secondary</code>, and <code>.border-danger</code>.
                        You can also use custom color classes to match your design. These classes allow you to easily
                        style the borders of your components.
                    </p>
                    <div class="d-flex align-items-start flex-wrap gap-4 text-center pb-4">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <p class="text-muted">Control border radius in Bootstrap using the <code>.rounded</code> class for
                    ...
                    directions, <code>.rounded-circle</code> for circular elements, and <code>.rounded-0-5</code> for a
                    specific radius value. These classes enhance the visual appeal of your components.</p>
                <div class="row">
                    <div class="col-xl-6">
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">Breakpoints</h5>
            </div>
            <div class="card-body">
                <p class="text-muted">Bootstrap's breakpoints allow you to create responsive layouts by applying classes
                    like <code>.col-sm-*</code>, <code>.col-md-*</code>, and <code>.col-lg-*</code>. These classes
                    adjust column sizes at different screen widths, ensuring your design looks great on all devices.</p>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <p class="text-muted">Use Bootstrap's container classes to create responsive fixed-width or fluid
                    ...
                    <code>.container-fluid</code> stretches to the full width of the viewport, adapting to screen size.
                </p>
                <div class="table-responsive">
                    <table class="table table-bordered table-hover table-nowrap mb-0">
                        <thead>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <p class="text-muted">Utilize Bootstrap's theme colors by applying classes like
                    <code>.text-primary</code> and <code>.bg-secondary</code> to elements. These classes enable you to
                    easily incorporate the predefined color palette, ensuring a consistent design throughout your
                    project.
                </p>
                <div class="row g-3">
                    <div class="col-md-4">
                ...
                <div class="row">
                    <div class="col-xl-6">
                        ...
                        <p class="text-muted">Change text colors in Bootstrap using classes like
                            <code>.text-primary</code>, <code>.text-secondary</code>, and others. These classes apply
                            different colors to text based on the Bootstrap theme palette.
                        </p>
                    ...
                    <div class="col-xl-6">
                        ...
                        <p class="text-muted">Use the <code>.text-gray-*</code> classes in Bootstrap to apply various
                            shades of gray to text. The asterisk (*) represents different shades, allowing you to adjust
                            the text color for a softer appearance.</p>
                ...
                <div class="row">
                    <div class="col-xl-6">
                        ...
                        <p class="text-muted">Apply background theme colors in Bootstrap using classes like
                            <code>.bg-primary</code>, <code>.bg-secondary</code>, and others. These classes add color to
                            the background based on the Bootstrap theme palette.
                        </p>
                    ...
                    <div class="col-xl-6">
                        ...
                        <p class="text-muted">Use the <code>.bg-*-subtle</code> classes in Bootstrap to apply light
                            background colors. The asterisk (*) represents any color from the Bootstrap color palette,
                            providing a subtle and gentle tone to your elements.</p>
                        <p class="rounded bg-primary-subtle text-primary-emphasis p-3 mb-3">.bg-primary-subtle </p>
                        <p class="rounded bg-secondary-subtle text-secondary-emphasis p-3 mb-3">.bg-secondary-subtle
                        </p>
                    ...
                    <div class="col-lg-12">
                        ...
                        <p class="text-muted">Adjust background opacity in Bootstrap using the
                            <code>.bg-opacity-*</code> classes, where * can be a value from 0 to 100. This controls the
                            transparency of the background color, allowing for layered effects.
                        </p>
                        <div class="d-flex align-items-start flex-wrap gap-4 text-center pb-4">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <p class="text-muted mb-3">Manage text selection in Bootstrap using classes like
                    ...
                    selection, and <code>.user-select-auto</code> for default behavior.
                </p>
    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <p class="text-muted mb-3">Control pointer events in Bootstrap using <code>.pe-none</code> to disable
                    interactions and <code>.pe-auto</code> to enable them. These classes manage whether elements can be
                    clicked or hovered.</p>
                <p><a href="javascript:void(0)" class="text-primary pe-none" tabindex="-1">This link</a> can not be
                    clicked.</p>
                <p><a href="javascript:void(0)" class="text-primary pe-auto">This link</a> can be clicked (this is
                    default behavior).</p>
                <p class="pe-none mb-0"><a href="javascript:void(0)" class="text-primary" tabindex="-1">This link</a>
                    can not be clicked because the <code>pointer-events</code> property is inherited from its parent.
                    However, <a href="javascript:void(0)" class="pe-auto">this link</a> has a <code>pe-auto</code> class
                    and can be clicked.</p>
            </div>
        </div>
    </div><!--End col-->
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="col-xl-6">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title">Stacks - Vertical</h5>
                        </div>
                        <div class="card-body">
                ...
                <div class="col-xl-6">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title">Stacks - Horizontal</h5>
                        </div>
                        <div class="card-body">
                ...
                <div class="col-xl-6">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title">Text truncation</h5>
                        </div>
                        <div class="card-body">
