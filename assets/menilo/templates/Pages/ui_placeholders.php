<?= $this->element('title_meta', ['title' => 'UI Placeholders']) ?>

<!-- prism css -->
<link rel="stylesheet" href="assets/libs/prismjs/themes/prism-coy.min.css" />

<?= $this->element('page_title', ['title' => 'Base UI', 'subTitle' => 'Placeholders']) ?>
    ...
    <div class="col-12">
        <div class="card card-h-100">
            <div class="card-header">
                <h5 class="card-title">Placeholder Cards</h5>
                ...
                <div class="tab-content" id="card-placeholderContent">
                    <div class="tab-pane fade show active" id="html-card-placeholder" role="tabpanel"
                        ...
                        <div class="row gy-3">
                            ...
                            <div class="col-md-6 col-xl-4">
                                <div class="card mb-0 h-100" aria-hidden="true"><img
                                        class="card-img-top h-200px img-fluid object-fit-cover"
                                        src="assets/images/placeholder-3.jpg" alt="#">
                                    <div class="card-body">
                                        <h6 class="card-title"><span class="placeholder col-6 placeholder-light"></span>
                                        </h6>
...
&lt;/div&gt;&lt;!--End row--&gt;</code></pre>
    ...
    <div class="col-lg-6">
        <div class="card card-h-100">
            ...
            <div class="card-body">
                <p class="text-muted">You can change the width through grid column classes, width utilities, or inline
                    styles.<code> (like: w-25 , w-50 , w-75 , w-100 ) </code></p>
...
&lt;/div&gt;</code></pre>
    ...
    <div class="col-lg-6">
        <div class="card card-h-100">
            ...
            <div class="card-body">
                <p class="text-muted">The size of <code>placeholder</code> are based on the typographic style of the
                    parent element. Customize them with sizing modifiers:
                    <code>placeholder-lg, placeholder-sm, or placeholder-xs</code>.</p>
...
&lt;/div&gt;</code></pre>
    ...
    <div class="col-12">
        <div class="card card-h-100">
            <div class="card-header">
                <h5 class="card-title">Placeholder Animations</h5>
                <ul class="nav nav-pills nav-preview nav-primary mb-0" id="animations-placeholder" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="html-animations-placeholder-tab" data-bs-toggle="pill"
                            data-bs-target="#html-animations-placeholder" type="button" role="tab"
                            aria-controls="html-animations-placeholder" aria-selected="true">HTML</button>
                    </li>
                    <li class="nav-item" role="presentation">
            ...
            <div class="card-body">
                <p class="text-muted">Add animations to Bootstrap placeholders using the <code>.placeholder-glow</code>
                    or <code>.placeholder-wave</code> classes for a smooth loading effect while content is being loaded.
                </p>
                <div class="tab-content" id="animations-placeholderContent">
                    <div class="tab-pane fade show active" id="html-animations-placeholder" role="tabpanel"
                        ...
                        <div>
                            <p class="placeholder-glow mb-0"><span class="placeholder col-12 placeholder-light"></span>
                            </p>
                            <p class="placeholder-wave mb-0"><span class="placeholder col-12 placeholder-light"></span>
                            </p>
                        </div>
                    </div>
...
&lt;/div&gt;</code></pre>
    ...
    <div class="col-lg-6">
        <div class="card card-h-100">
            <div class="card-header">
                <h5 class="card-title">Colors Placeholder</h5>
...
&lt;/div&gt;</code></pre>
    ...
    <div class="col-lg-6">
        <div class="card card-h-100">
            <div class="card-header">
                <h5 class="card-title">Custom Animation Placeholder</h5>
                <ul class="nav nav-pills nav-preview nav-primary mb-0" id="custom-animation-placeholder" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="html-custom-animation-placeholder-tab" data-bs-toggle="pill"
                            data-bs-target="#html-custom-animation-placeholder" type="button" role="tab"
                            aria-controls="html-custom-animation-placeholder" aria-selected="true">HTML</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="preview-custom-animation-placeholder-tab" data-bs-toggle="pill"
                            data-bs-target="#preview-custom-animation-placeholder" type="button" role="tab"
                            aria-controls="preview-custom-animation-placeholder" aria-selected="false">Preview</button>
                    </li>
                </ul>
            </div>
            <div class="card-body">
                <p class="text-muted">With the <code>wave-left-lines</code> custom animation, placeholders may be used
                    into your unique design.</p>
        ...
        <div class="card card-h-100">
            ...
            <div class="card-body">
                <p class="text-muted">Create interactive placeholders in Bootstrap by using buttons or links. When
                    clicked, the placeholder content is replaced with the actual content, simulating a loading effect.
                </p>
