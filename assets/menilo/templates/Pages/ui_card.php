<?= $this->element('title_meta', ['title' => 'UI Card']) ?>

<?= $this->element('page_title', ['title' => 'Base UI', 'subTitle' => 'Card']) ?>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-xl-3">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h6 class="card-title fw-semibold">New Message</h6>
                            <div class="dropdown">
                                <button type="button" class="btn btn-light btn-sm" type="button" data-bs-toggle="dropdown">
                ...
                <div class="col-md-6 col-xl-3">
                    <div class="card">
                        ...
                        <div class="card-footer d-flex justify-content-between">
                            ...
                            <a href="javascript:void(0)" class="link link-primary">Read More<i class="ri-arrow-right-double-line"></i></a>
                        </div>
                    </div>
                </div><!--End col-->
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h5 class="card-title">Welcome to Our Service</h5>
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h5 class="card-title">Danger Alert</h5>
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h5 class="card-title">Low Storage Warning</h5>
                            <div class="dropdown">
                                <button type="button" class="btn btn-light btn-sm" type="button" data-bs-toggle="dropdown">
                                    <i class="ri-more-2-fill"></i>
                                </button>
                ...
                <div class="col-md-6 col-xl-3">
                    <div class="card">
                        <div class="card-header pb-5">
                            <h5 class="card-title">Success Card with Image</h5>
                        </div>
            ...
            <h5 class="mb-3">Card Colors</h5>
            <div class="row">
                <div class="col-md-6 col-xl-3">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h6 class="card-title text-white">Primary Card</h6>
                        </div>
                        <div class="card-body">
                            <p class="card-text">
                                You have received a new message from John Doe regarding your recent inquiry.
                ...
                <div class="col-md-6 col-xl-3">
                    <div class="card card-secondary">
                        <div class="card-header">
                            <h6 class="card-title text-white">Secondary Card</h6>
                        </div>
                        <div class="card-body">
                            <p class="card-text">
                                You have received a new message from John Doe regarding your recent inquiry.
                ...
                <div class="col-md-6 col-xl-3">
                    <div class="card card-success">
                        <div class="card-header">
                            <h6 class="card-title text-white">Success Card</h6>
                        </div>
                        <div class="card-body">
                            <p class="card-text">
                                You have received a new message from John Doe regarding your recent inquiry.
                ...
                <div class="col-md-6 col-xl-3">
                    <div class="card card-info">
                        <div class="card-header">
                            <h6 class="card-title text-white">Info Card</h6>
                        </div>
                        <div class="card-body">
                            <p class="card-text">
                                You have received a new message from John Doe regarding your recent inquiry.
                ...
                <div class="col-md-6 col-xl-3">
                    <div class="card card-warning">
                        <div class="card-header">
                            <h6 class="card-title text-white">Warning Card</h6>
                        </div>
                        <div class="card-body">
                            <p class="card-text">
                                You have received a new message from John Doe regarding your recent inquiry.
                ...
                <div class="col-md-6 col-xl-3">
                    <div class="card card-danger">
                        <div class="card-header">
                            <h6 class="card-title text-white">Danger Card</h6>
                        </div>
                        <div class="card-body">
                            <p class="card-text">
                                You have received a new message from John Doe regarding your recent inquiry.
                ...
                <div class="col-md-6 col-xl-3">
                    <div class="card card-dark">
                        <div class="card-header">
                            <h6 class="card-title text-white">Dark Card</h6>
                        </div>
                        <div class="card-body">
                            <p class="card-text">
                                You have received a new message from John Doe regarding your recent inquiry.
