<?= $this->element('title_meta', ['title' => 'UI Off-Canvas']) ?>

<!-- prism css -->
<link rel="stylesheet" href="assets/libs/prismjs/themes/prism-coy.min.css">

<?= $this->element('page_title', ['title' => 'Base UI', 'subTitle' => 'Off-Canvas']) ?>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">Offcanvas Basic</h5>
            ...
            <div class="card-body">
                <p class="text-muted mb-4">Use the buttons below to show and hide an offcanvas element via JavaScript
...
&lt;/div&gt;</code></pre>
    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">Body Scrolling</h5>
...
&lt;/div&gt;</code></pre>
    ...
    <div class="col-xl-6">
        <div class="card">
            ...
            <div class="card-body">
                <p class="text-muted mb-4">When backdrop is set to static, the offcanvas will not close when clicking
                    outside of it.</p>
...
&lt;/div&gt;</code></pre>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">Body Scrolling & Backdrop</h5>
                <ul class="nav nav-pills nav-preview nav-primary mb-0" id="body-scrolling-backdrop" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="html-body-scrolling-backdrop-tab" data-bs-toggle="pill"
                            data-bs-target="#html-body-scrolling-backdrop" type="button" role="tab"
                            aria-controls="html-body-scrolling-backdrop" aria-selected="true">HTML</button>
                    </li>
                    <li class="nav-item" role="presentation">
            ...
            <div class="card-body">
                <p class="text-muted mb-4">Scrolling the <code>&lt;body&gt;</code> element is disabled when an offcanvas
                    and its backdrop are visible. Use the data-bs-scroll attribute to enable <code>&lt;body&gt;</code>
                    scrolling.</p>
                <div class="tab-content" id="body-scrolling-backdropContent">
                    <div class="tab-pane fade show active" id="html-body-scrolling-backdrop" role="tabpanel"
                        ...
                        <button class="btn btn-primary" type="button" data-bs-toggle="offcanvas"
                            data-bs-target="#offcanvasWithBothOptions2" aria-controls="offcanvasWithBothOptions2">Enable
                            both scrolling & backdrop</button>

                        <div class="offcanvas offcanvas-start" data-bs-scroll="true" tabindex="-1"
                            id="offcanvasWithBothOptions2" aria-labelledby="offcanvasWithBothOptions2Label">
                            <div class="offcanvas-header">
                                <h5 class="offcanvas-title" id="offcanvasWithBothOptions2Label">Backdrop with scrolling
                                </h5>
                                <button type="button" class="btn-close" data-bs-dismiss="offcanvas"
                                    aria-label="Close"></button>
                            </div>
                            <div class="offcanvas-body">
                                <div class="card">
                                    ...
                                    <div class="card-body p-4 text-center">
                                        ...
                                        <p class="card-text text-muted">Experience cutting-edge technology with heart
                                            rate monitoring, GPS tracking, and customizable watch faces.</p>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body p-4 text-center">
                                        ...
                                        <p class="card-text text-muted">Hurry! Limited-time offers on selected items.
                                            Don't miss out on great deals!</p>
...
&lt;/div&gt;</code></pre>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">Offcanvas Placements</h5>
            ...
            <div class="card-body">
                ...
                <div class="tab-content" id="offcanvas-placementsContent">
                    <div class="tab-pane fade show active" id="html-offcanvas-placements" role="tabpanel"
                        ...
                        <!-- start:: Top Offcanvas -->
                        <div class="offcanvas offcanvas-topmin-h-500px" tabindex="-1" id="offcanvasTop" aria-labelledby="offcanvasTopLabel">
                                        <div class="offcanvas-header">
                                            <h5 class="offcanvas-title" id="offcanvasStartLabel">Explore Our Offerings</h5>
                                        ...
                                        <div class="offcanvas-body">
                                            ...
                                            <div class="row g-5">
                                                <div class="col-12 col-sm-6 col-lg-4 col-xl-3">
                                                    <div class="card mb-0">
                                                        <img src="assets/images/small/img-2.jpg" class="img-fluid object-fit-cover rounded-top h-224px" alt="Recent Activity 1">
                                                        <div class="card-body p-4 text-center">
                                                            <i class="ri-rocket-line ri-2x mb-3 text-primary"></i>
                                                            <h5 class="card-title"><strong>New Launch:</strong> Smartwatch XYZ</h5>
                                                ...
                                                <div class="col-12 col-sm-6 col-lg-4 col-xl-3">
                                                    <div class="card mb-0">
                                                        <img src="assets/images/small/img-2.jpg" class="img-fluid object-fit-cover rounded-top h-224px" alt="Recent Activity 2">
                                                        <div class="card-body p-4 text-center">
                                                            <i class="ri-store-line ri-2x mb-3 text-danger"></i>
                                                            <h5 class="card-title"><strong>Flash Sale:</strong> Up to 50% off!</h5>
                                                ...
                                                <div class="col-12 col-sm-6 col-lg-4 col-xl-3">
                                                    <div class="card mb-0">
                                                        <img src="assets/images/small/img-2.jpg" class="img-fluid object-fit-cover rounded-top h-224px" alt="Recent Activity 3">
                                                        <div class="card-body p-4 text-center">
                                                            <i class="ri-t-shirt-line ri-2x mb-3 text-success"></i>
                                                ...
                                                <div class="col-12 col-sm-6 col-lg-4 col-xl-3">
                                                    <div class="card mb-0">
                                                        <img src="assets/images/small/img-2.jpg" class="img-fluid object-fit-cover rounded-top h-224px" alt="Recent Activity 4">
                                                        <div class="card-body p-4 text-center">
                                                            <i class="ri-smartphone-line ri-2x mb-3 text-info"></i>
                                    ...
                                    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasEnd" aria-labelledby="offcanvasEndLabel">
                                        ...
                                        <div class="offcanvas-body">
                                            ...
                                            <div class="card">
                                                <img src="assets/images/small/img-6.jpg" class="img-fluid rounded-top max-h-240px object-fit-cover" alt="Recent Activity 1">
                                                <div class="card-body p-4 text-center">
                                                    <i class="ri-rocket-line ri-2x mb-3 text-primary"></i>
                                                    <h5 class="card-title"><strong>New Launch:</strong> Smartwatch XYZ</h5>
                                            ...
                                            <div class="card">
                                                <img src="assets/images/small/img-7.jpg" class="img-fluid rounded-top max-h-240px object-fit-cover" alt="Recent Activity 2">
                                                <div class="card-body p-4 text-center">
                                                    <i class="ri-store-line ri-2x mb-3 text-danger"></i>
                                                    <h5 class="card-title"><strong>Flash Sale:</strong> Up to 50% off!</h5>
                                            ...
                                            <div class="card">
                                                <img src="assets/images/small/img-8.jpg" class="img-fluid rounded-top max-h-240px object-fit-cover" alt="Recent Activity 3">
                                                <div class="card-body p-4 text-center">
                                                    <i class="ri-t-shirt-line ri-2x mb-3 text-success"></i>
                                                    <h5 class="card-title"><strong>New Arrivals:</strong> Latest Fashion Trends</h5>
                                            ...
                                            <div class="card">
                                                <img src="assets/images/small/img-9.jpg" class="img-fluid rounded-top max-h-240px object-fit-cover" alt="Recent Activity 4">
                                                <div class="card-body p-4 text-center">
                                                    <i class="ri-smartphone-line ri-2x mb-3 text-info"></i>
                                                    <h5 class="card-title"><strong>Tech Update:</strong> Explore New Gadgets</h5>
                                    ...
                                    <div class="offcanvas offcanvas-bottom min-h-500px" tabindex="-1" id="offcanvasBottom" aria-labelledby="offcanvasBottomLabel">
                                        <div class="offcanvas-header">
                                            <h5 class="offcanvas-title" id="offcanvasStartLabel">Explore Our Offerings</h5>
                                            <button type="button" class="btn-close icon-btn-sm" data-bs-dismiss="offcanvas" aria-label="Close">
                                                <i class="ri-close-large-line fw-semibold"></i>
