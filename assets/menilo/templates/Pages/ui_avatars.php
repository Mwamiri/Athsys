<?= $this->element('title_meta', ['title' => 'Avatars']) ?>

<!-- prism css -->
<link rel="stylesheet" href="assets/libs/prismjs/themes/prism-coy.min.css">

<?= $this->element('page_title', ['title' => 'Base UI', 'subTitle' => 'Avatars']) ?>
    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">Basic Avatars</h5>
                <ul class="nav nav-pills nav-preview nav-primary mb-0" id="basic-avatar-group" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="html-basic-avatar-group-tab" data-bs-toggle="pill"
                            data-bs-target="#html-basic-avatar-group" type="button" role="tab"
                            aria-controls="html-basic-avatar-group" aria-selected="true">HTML</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="preview-basic-avatar-group-tab" data-bs-toggle="pill"
                            data-bs-target="#preview-basic-avatar-group" type="button" role="tab"
                            aria-controls="preview-basic-avatar-group" aria-selected="false">Preview</button>
                    </li>
                </ul>
            </div>
            <div class="card-body">
                <div class="tab-content" id="basic-avatar-group">
                    <div class="tab-pane fade show active" id="html-basic-avatar-group" role="tabpanel"
                        aria-labelledby="html-basic-avatar-group-tab" tabindex="0">
                    ...
                    <div class="tab-pane fade" id="preview-basic-avatar-group" role="tabpanel"
                        aria-labelledby="preview-basic-avatar-group-tab" tabindex="0">
...
&lt;/div&gt;</code></pre>
    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">Avatars Group Image</h5>
...
&lt;/div&gt;</code></pre>
    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">Avatars Letter</h5>
...
&lt;/div&gt;</code></pre>
    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">Avatars Group Letter</h5>
...
&lt;/div&gt;</code></pre>
    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">Light Avatars Letter</h5>
                <ul class="nav nav-pills nav-preview nav-primary mb-0" id="light-avatar-letters" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="html-light-avatar-letters-tab" data-bs-toggle="pill"
                            data-bs-target="#html-light-avatar-letters" type="button" role="tab"
                            aria-controls="html-light-avatar-letters" aria-selected="true">HTML</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="preview-light-avatar-letters-tab" data-bs-toggle="pill"
                            data-bs-target="#preview-light-avatar-letters" type="button" role="tab"
                            aria-controls="preview-light-avatar-letters" aria-selected="false">Preview</button>
                    </li>
                </ul>
            </div>
            <div class="card-body">
                <div class="tab-content" id="light-avatar-letters">
                    <div class="tab-pane fade show active" id="html-light-avatar-letters" role="tabpanel"
                        aria-labelledby="html-light-avatar-letters-tab" tabindex="0">
                        <div class="d-flex align-items-center flex-wrap">
                    ...
                    <div class="tab-pane fade" id="preview-light-avatar-letters" role="tabpanel"
                        aria-labelledby="preview-light-avatar-letters-tab" tabindex="0">
                        <pre class="language-html"><code>&lt;div class=&quot;avatar-item avatar-md avatar-title text-white bg-primary&quot;&gt;
    PR
&lt;/div&gt;
&lt;div class=&quot;avatar-item avatar-md avatar-title text-secondary bg-secondary-subtle&quot;&gt;
...
&lt;/div&gt;</code></pre>
    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">Light Avatars Group Letter</h5>
                <ul class="nav nav-pills nav-preview nav-primary mb-0" id="light-avatar-group-letter" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="html-light-avatar-group-letter-tab" data-bs-toggle="pill"
                            data-bs-target="#html-light-avatar-group-letter" type="button" role="tab"
                            aria-controls="html-light-avatar-group-letter" aria-selected="true">HTML</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="preview-light-avatar-group-letter-tab" data-bs-toggle="pill"
                            ...
                            aria-controls="preview-light-avatar-group-letter" aria-selected="false">Preview</button>
                    </li>
                </ul>
            </div>
            <div class="card-body">
...
&lt;/div&gt;</code></pre>
    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">Indicator Position And Icon</h5>
                <ul class="nav nav-pills nav-preview nav-primary mb-0" id="indicator-position-icon-avatar"
                    role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="html-indicator-position-icon-avatar-tab"
                            data-bs-toggle="pill" data-bs-target="#html-indicator-position-icon-avatar" type="button"
                            role="tab" aria-controls="html-indicator-position-icon-avatar"
                            aria-selected="true">HTML</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="preview-indicator-position-icon-avatar-tab" data-bs-toggle="pill"
                            data-bs-target="#preview-indicator-position-icon-avatar" type="button" role="tab"
                            aria-controls="preview-indicator-position-icon-avatar"
            ...
            <div class="card-body">
                <div class="tab-content" id="indicator-position-icon-avatar">
                    <div class="tab-pane fade show active" id="html-indicator-position-icon-avatar" role="tabpanel"
                        aria-labelledby="html-indicator-position-icon-avatar-tab" tabindex="0">
                        <div class="d-flex align-items-center flex-wrap gap-3">
                            <div class="position-relative">
                                ...
                                <span
                                    class="position-absolute border-2 border border-light-subtle h-12px w-12px rounded-circle bg-primary end-0 bottom-0"></span>
                            </div>
                            <div class="position-relative">
                                <div class="avatar-item avatar-md avatar-title text-danger bg-danger-subtle">
                                    <i class="ri-user-fill"></i>
                                ...
                                <span
                                    class="position-absolute border-2 border border-light-subtle h-12px w-12px rounded-circle bg-danger end-0 top-0"></span>
                            </div>
                            <div class="position-relative">
                                ...
                                <span
                                    class="position-absolute border-2 border border-light-subtle h-12px w-12px rounded-circle bg-success end-0 bottom-0"></span>
                            </div>
                            <div class="position-relative">
                                <div class="avatar-item avatar-md">
                                    <img class="img-fluid avatar-md" src="assets/images/avatar/avatar-3.jpg"
                                ...
                                <span
                                    class="position-absolute border-2 border border-light-subtle h-12px w-12px rounded-circle bg-success end-0 top-0"></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="tab-pane fade show active" id="html-radius-avatar" role="tabpanel"
                        ...
                        <div class="d-flex align-items-center flex-wrap gap-3">
                            ...
                            <div class="avatar-item avatar-lg">
                                <img class="img-fluid avatar-lg rounded-0" src="assets/images/avatar/avatar-3.jpg"
                                    alt="avatar image">
                            </div>
                            <div class="avatar-item avatar-lg">
                                <img class="img-fluid avatar-lg rounded-2" src="assets/images/avatar/avatar-3.jpg"
                                    alt="avatar image">
                            </div>
                            <div class="avatar-item avatar-lg">
                                <img class="img-fluid avatar-lg" src="assets/images/avatar/avatar-3.jpg"
                                    alt="avatar image">
                            </div>
                        </div>
                    </div>
...
&lt;/div&gt;</code></pre>
    ...
    <div class="col-xl-6">
        <div class="card card-h-100">
            <div class="card-header">
                <h5 class="card-title">Basic Avatars Size</h5>
                <ul class="nav nav-pills nav-preview nav-primary mb-0" id="size-avatar" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="html-size-avatar-tab" data-bs-toggle="pill"
                            data-bs-target="#html-size-avatar" type="button" role="tab" aria-controls="html-size-avatar"
                            aria-selected="true">HTML</button>
                    </li>
                    <li class="nav-item" role="presentation">
                    ...
                    <div class="tab-pane fade show active" id="html-size-avatar" role="tabpanel"
                        ...
                        <div class="d-flex align-items-center flex-wrap gap-3">
                            <div class="avatar-item avatar-xl">
                                <img class="img-fluid avatar-xl" src="assets/images/avatar/avatar-3.jpg"
                                    alt="avatar image">
                            </div>
                            <div class="avatar-item avatar-lg">
                                <img class="img-fluid avatar-lg" src="assets/images/avatar/avatar-3.jpg"
                            ...
                            <div class="avatar-item avatar-xs">
                                <img class="img-fluid avatar-xs" src="assets/images/avatar/avatar-3.jpg"
                                    alt="avatar image">
                            </div>
                        </div>
                    </div>
                    <div class="tab-pane fade" data-id="preview-size-avatar" role="tabpanel"
...
&lt;/div&gt;</code></pre>
    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">Avatars Group Size</h5>
