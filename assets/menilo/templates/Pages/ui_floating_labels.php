<?= $this->element('title_meta', ['title' => 'UI Floating Labels']) ?>

<?= $this->element('page_title', ['title' => 'Forms', 'subTitle' => 'Floating Labels']) ?>

<div class="row">
    <div class="col-12 col-xl-6 col-xxl-4">
        <div class="card card-h-100">
            <div class="card-header">
                <h5 class="card-title">Basic Floating Label</h5>
            </div>
            <div class="card-body">
                <p class="text-muted mb-4">Use the fields below to enter a date. Please follow the specified format for
                    each field:</p>
    ...
    <div class="col-12 col-xl-6 col-xxl-4">
        <div class="card card-h-100">
            <div class="card-header">
                <h5 class="card-title">Floating Label With Values</h5>
            </div>
            <div class="card-body">
                <p class="text-muted mb-4">Use the fields below to enter a date. Please follow the specified format for
                    each field:</p>
    ...
    <div class="col-12 col-xl-6 col-xxl-4">
        <div class="card card-h-100">
            <div class="card-header">
                <h5 class="card-title">Invalid Floating Label</h5>
            </div>
            <div class="card-body">
                <p class="text-muted mb-4">Use the fields below to enter a date. Please follow the specified format for
                    each field:</p>
    ...
    <div class="col-12 col-xl-6 col-xxl-4">
        <div class="card card-h-100">
            <div class="card-header">
                <h5 class="card-title">Floating Textarea</h5>
            </div>
            <div class="card-body">
                <p class="text-muted mb-4">Use the fields below to enter a date. Please follow the specified format for
                    each field:</p>
                ...
                <div class="form-floating">
                    <textarea class="form-control h-100px" placeholder="Leave a comment here"
    ...
    <div class="col-12 col-xl-6 col-xxl-4">
        <div class="card card-h-100">
            <div class="card-header">
                <h5 class="card-title">Floating Select</h5>
            </div>
            <div class="card-body">
                <p class="text-muted mb-4">Use the fields below to enter a date. Please follow the specified format for
                    each field:</p>
    ...
    <div class="col-12 col-xl-6 col-xxl-4">
        <div class="card card-h-100">
            <div class="card-header">
                <h5 class="card-title">Floating Input groups</h5>
            </div>
            <div class="card-body">
                <p class="text-muted mb-4">Use the fields below to enter a date. Please follow the specified format for
                    each field:</p>
